...
function Me(e = [], r, a, s, i, o) {
  return {
    ...
    _refinements: o,
    validate(d) {
      return Me([...e, d], r, a, s, i, o);
    },
  };
}
function te(e, r, a, s, i, o) {
  return {
    ...Me(e, r, a, s, i, o),
    default(d) {
      return te(e, r, d, s, i, o);
    },
    transform(d) {
      return te(
        [],
    ...
    brand() {
      return te(e, `Branded<${r}>`, a, s, i, o);
    },
    describe(d) {
      return te(e, r, a, s, d, o);
    },
    refine(d, u) {
      const g = [...(o ?? []), { predicate: d, message: u }];
      return te([...e, d], r, a, s, i, g);
    },
    nullable() {
      return te(
...
var G = {
  ...
  array() {
    const e = (r, a, s, i, o) => {
      ...
      return {
        ...
        nonEmpty() {
          return e([...r, (g) => g.length > 0], a, s, i, u);
        },
        maxLength(g) {
          return e([...r, (m) => m.length <= g], a, s, i, u);
        },
        minLength(g) {
          return e([...r, (m) => m.length >= g], a, s, i, u);
        },
  ...
  object() {
    const e = (r, a, s) => ({
          ...
          [
            ...
            (o) => {
              for (const [d, u] of Object.entries(i)) {
                const g = o[d],
                  m = u;
                if (m && !m._validators.every((c) => c(g))) return !1;
              }
              return !0;
            },
          ],
      ...
      nonNull() {
        return e([...r, (i) => i != null], a, s);
      },
      hasKeys(...i) {
        return e([...r, (o) => i.every((d) => d in o)], a, s);
      },
      default(i) {
        return e(r, i, s);
      },
...
function Tt(e) {
  const { schema: r, onChange: a, onBatch: s } = e;
    ...
    for (let z = 0; z < P.length; z++) {
      ...
      if (typeof y == "function" && !y(b)) {
        let C = b === null ? "null" : Array.isArray(b) ? "array" : typeof b,
          t = B(b),
          n = "";
        typeof T._lastFailedIndex == "number" &&
          T._lastFailedIndex >= 0 &&
          ((n = ` (element at index ${T._lastFailedIndex} failed)`),
          (T._lastFailedIndex = -1));
  ...
  const F = {
    ...
    subscribe(f, b) {
      for (const w of f) {
        const T = w;
        m.has(T) || m.set(T, new Set()), m.get(T).add(b);
      }
      return () => {
        for (const w of f) {
          const T = m.get(w);
          T && (T.delete(b), T.size === 0 && m.delete(w));
        }
      };
    },
    subscribeAll(f) {
  ...
  return (
    (F.registerKeys = (f) => {
      for (const b of Object.keys(f)) Se.has(b) || ((r[b] = f[b]), g.add(b));
    }),
    F
  );
}
  ...
  function s(i, o) {
    ...
    if (d === "object") {
      ...
      const g = `{${Object.keys(u)
        .sort()
        .map((m) => `${JSON.stringify(m)}:${s(u[m], o + 1)}`)
        .join(",")}}`;
      return a.delete(u), g;
    }
    return '"[unknown]"';
...
function Ee(e, r = 50) {
  ...
  function i(o, d) {
    ...
    if ((s.add(u), Array.isArray(u))) {
      for (const g of u) if (!i(g, d + 1)) return s.delete(u), !1;
      return s.delete(u), !0;
    }
    for (const g of Object.keys(u))
      if (a.has(g) || !i(u[g], d + 1)) return s.delete(u), !1;
    return s.delete(u), !0;
  }
  return i(e, 0);
}
function Ft(e) {
  let r = vt(e),
    a = 5381;
  for (let s = 0; s < r.length; s++) a = ((a << 5) + a) ^ r.charCodeAt(s);
...
function Lt(e, r, a) {
  return { requirement: e, id: zt(e, a), fromConstraint: r };
}
var Le = class bt {
    map = new Map();
    add(r) {
    ...
    diff(r) {
      const a = [],
        s = [],
        i = [];
      for (const o of this.map.values()) r.has(o.id) ? i.push(o) : a.push(o);
...
function Pt(e) {
  ...
  function v() {
    ...
    function h(S, j) {
      ...
      n.add(S), j.push(S);
      const L = r[S];
      if (L?.after) for (const W of L.after) r[W] && h(W, j);
      j.pop(), n.delete(S), t.add(S), l.push(S);
    }
    for (const S of Object.keys(r)) h(S, []);
    (B = l), (p = new Map(B.map((S, j) => [S, j])));
  }
  v(), x();
  function $(t, n) {
  ...
  function b(t) {
    ...
    try {
      let h;
      if (n.deps) (h = n.when(a)), A.set(t, new Set(n.deps));
      else {
        const S = Ae(() => n.when(a));
      ...
      return h instanceof Promise
        ...
        : ((l.lastResult = h), (l.isEvaluating = !1), o?.(t, h), h);
    } catch (h) {
      return (
        (l.error = h instanceof Error ? h : new Error(String(h))),
        (l.lastResult = !1),
        (l.isEvaluating = !1),
        d?.(t, h),
        !1
  ...
  async function w(t) {
    ...
    try {
      const S = n.when(a),
        j = await Ce(S, h, `Constraint "${t}" timed out after ${h}ms`);
      return (l.lastResult = j), (l.isEvaluating = !1), o?.(t, j), j;
    } catch (S) {
      return (
        (l.error = S instanceof Error ? S : new Error(String(S))),
        (l.lastResult = !1),
  ...
  function P(t) {
    ...
    if (typeof l == "function") {
      const { value: h, deps: S } = Ae(() => l(a));
      return { requirements: T(h), deps: S };
    }
    return { requirements: T(l), deps: new Set() };
  }
  function H(t, n) {
    if (n.size === 0) return;
    const l = c.get(t) ?? new Set();
    for (const h of n)
      l.add(h), E.has(h) || E.set(h, new Set()), E.get(h).add(t);
    c.set(t, l);
  }
  let z = null;
  function y() {
  ...
  function C(t) {
    ...
    for (const l of n.after)
      if (r[l] && !g.has(l) && !D.has(l) && !R.has(l)) return !1;
    return !0;
  }
  return {
    async evaluate(t) {
      const n = new Le();
      D.clear();
      let l = y().filter((_) => !g.has(_)),
        h;
      if (!M || !t || t.size === 0) (h = l), (M = !0);
      else {
        const _ = new Set();
        for (const V of t) {
          const J = E.get(V);
          if (J) for (const re of J) g.has(re) || _.add(re);
        }
        for (const V of I) g.has(V) || _.add(V);
        I.clear(), (h = [..._]);
        for (const V of l)
          if (!_.has(V)) {
            const J = O.get(V);
      ...
      function S(_, V) {
        ...
        const J = A.get(_);
        if (!V) {
          J !== void 0 && f(_, J), D.add(_), O.set(_, []);
          return;
        }
        D.delete(_);
        let re, ee;
        try {
          const Q = P(_);
          (re = Q.requirements), (ee = Q.deps);
        } catch (Q) {
          d?.(_, Q), J !== void 0 && f(_, J), O.set(_, []);
          return;
        }
        if (J !== void 0) {
          const Q = new Set(J);
          for (const U of ee) Q.add(U);
          f(_, Q);
        } else H(_, ee);
        if (re.length > 0) {
          const Q = s[_],
            U = re.map((Y) => Lt(Y, _, Q));
          for (const Y of U) n.add(Y);
          O.set(_, U);
        } else O.set(_, []);
      }
      async function j(_) {
        ...
        const re = [],
          ee = [];
        for (const U of J) F(U).isAsync ? ee.push(U) : re.push(U);
        const Q = [];
        for (const U of re) {
          const Y = b(U);
          if (Y instanceof Promise) {
            Q.push({ id: U, promise: Y });
            continue;
          }
          S(U, Y);
        }
        if (Q.length > 0) {
          const U = await Promise.all(
            Q.map(async ({ id: Y, promise: X }) => ({
              id: Y,
              active: await X,
            })),
          );
          for (const { id: Y, active: X } of U) S(Y, X);
        }
        if (ee.length > 0) {
          const U = await Promise.all(
      ...
      while (L.length > 0 && W > 0) {
        const _ = L.length;
        if (((L = await j(L)), L.length === _)) break;
        W--;
      }
      return n.all();
    },
    ...
    disable(t) {
      g.add(t), (z = null), O.delete(t);
      const n = c.get(t);
      if (n) {
        for (const l of n) {
          const h = E.get(l);
          h && (h.delete(t), h.size === 0 && E.delete(l));
        }
        c.delete(t);
      }
      A.delete(t);
    ...
    markResolved(t) {
      ...
      const l = N.get(t);
      if (l) for (const h of l) I.add(h);
    },
    isResolved(t) {
      return R.has(t);
    },
    registerDefinitions(t) {
      for (const [n, l] of Object.entries(t)) (r[n] = l), k(n), I.add(n);
      (z = null), v(), x();
    },
  };
}
function Wt(e) {
  ...
  function N(v) {
    ...
    $.isComputing = !0;
    try {
      const { value: F, deps: f } = Ae(() => k(a, M));
      return (
        ($.cachedValue = F), ($.isStale = !1), B(v, f), s?.(v, F, [...f]), F
      );
    } catch (F) {
      throw (o?.(v, F), F);
    } finally {
        ...
        while (I.size > 0) {
          if (++v > O) {
            ...
            throw (
              (I.clear(),
              new Error(
                `[Directive] Infinite derivation notification loop detected after ${O} iterations. Remaining: ${k.join(", ")}. This usually means a derivation listener is mutating facts that re-trigger the same derivation.`,
              ))
            );
          }
          const $ = [...I];
          I.clear();
          for (const k of $) u.get(k)?.forEach((F) => F());
        }
      } finally {
        A = !1;
      }
  ...
  function x(v, $ = new Set()) {
    ...
    (k.isStale = !0), i?.(v), I.add(v);
    const F = m.get(v);
    if (F) for (const f of F) x(f, $);
  }
  return (
    (M = new Proxy(
      {},
      {
        get(v, $) {
          ...
          ze($);
          const k = D($);
          return k.isStale && N($), k.cachedValue;
        },
      },
    )),
    {
      ...
      subscribe(v, $) {
        ...
        return () => {
          for (const k of v) {
            const F = k,
              f = u.get(F);
            f?.delete($), f && f.size === 0 && u.delete(F);
          }
        };
      },
      getProxy() {
...
function Ht(e) {
  let { definitions: r, facts: a, store: s, onRun: i, onError: o } = e,
    d = new Map(),
    u = null,
    g = !1;
  function m(R) {
    const D = r[R];
    if (!D) throw new Error(`[Directive] Unknown effect: ${R}`);
    const N = {
      id: R,
      enabled: !0,
  ...
  function I(R, D) {
    ...
    if (N.dependencies) {
      for (const B of N.dependencies) if (D.has(B)) return !0;
      return !1;
    }
    return !0;
  }
  ...
  async function M(R) {
    ...
    if (!(!D.enabled || !N)) {
      ...
      try {
        ...
        o?.(R, B),
          console.error(`[Directive] Effect "${R}" threw an error:`, B);
      }
    }
  }
  for (const R of Object.keys(r)) m(R);
  return {
    async runEffects(R) {
      const D = [];
      for (const N of Object.keys(r)) I(N, R) && D.push(N);
      await Promise.all(D.map(M)), (u = E());
    },
    async runAll() {
      const R = Object.keys(r);
      await Promise.all(
        R.map((D) => (c(D).enabled ? M(D) : Promise.resolve())),
      ),
        (u = E());
    },
    disable(R) {
    ...
    cleanupAll() {
      g = !0;
      for (const R of d.values()) A(R);
    },
    registerDefinitions(R) {
      for (const [D, N] of Object.entries(R)) (r[D] = N), m(D);
    },
  };
}
function Kt(e = {}) {
  const {
    ...
    o = new Map();
  function d(u) {
    const g = r * Math.pow(s, u - 1);
    return Math.min(g, i);
  }
  return {
    scheduleRetry(u, g, m, c, E) {
      if (c > a) return null;
      const I = d(c),
        A = {
          source: u,
    ...
    processDueRetries() {
      const u = Date.now(),
        g = [];
      for (const [m, c] of o) c.nextRetryTime <= u && (g.push(c), o.delete(m));
      return g;
    },
    cancelRetry(u) {
      o.delete(u);
...
function Vt(e = {}) {
  const { config: r = {}, onError: a, onRecovery: s } = e,
    i = [],
    o = 100,
    d = Kt(r.retryLater),
    u = new Map();
  function g(c, E, I, A) {
    if (I instanceof Ye) return I;
    const O = I instanceof Error ? I.message : String(I),
      M = c !== "system";
    return new Ye(O, c, E, A, M);
  }
  function m(c, E, I) {
    const A = (() => {
      switch (c) {
  ...
  return {
    handleError(c, E, I, A) {
      ...
      let M = m(c, E, I instanceof Error ? I : new Error(String(I)));
      if (M === "retry-later") {
        const R = (u.get(E) ?? 0) + 1;
        u.set(E, R),
          d.scheduleRetry(c, E, A, R) ||
            ((M = "skip"), u.delete(E), typeof process < "u");
      }
      try {
        s?.(O, M);
      } catch (R) {
...
var Ge = { attempts: 1, backoff: "none", initialDelay: 100, maxDelay: 3e4 },
  Xe = { enabled: !1, windowMs: 50 };
function Qe(e, r) {
...
function Jt(e) {
  ...
  function B(f, b) {
    return D(f) ? b.type === f.requirement : N(f) ? f.requirement(b) : !1;
  }
  function p(f) {
    const b = f.type,
      w = O.get(b);
    ...
    for (const [T, P] of Object.entries(r))
      if (B(P, f)) {
        ...
        const H = O.get(b);
        return H.includes(T) || H.push(T), T;
      }
    return null;
  }
  function x(f) {
  ...
  async function $(f, b) {
    ...
    for (let t = 1; t <= T.attempts; t++) {
      if (H.signal.aborted) return;
      try {
        const n = x(H.signal),
          l = b.map((h) => h.requirement);
        if (w.resolveBatchWithResults) {
          ...
          if (!L || b.some((W, _) => h[_]?.success)) return;
        } else {
          let h;
          s.batch(() => {
            h = w.resolveBatch(l, n);
          }),
            C && C > 0
              ? await Ce(h, C, `Batch resolver "${f}" timed out after ${C}ms`)
              : await h;
          const S = Date.now() - z;
          for (const j of b)
            E.set(j.id, {
        ...
        if (
          ...
          return;
        if (T.shouldRetry && !T.shouldRetry(y, t)) break;
        if (t < T.attempts) {
          const l = Qe(T, t);
          for (const h of b) u?.(f, h, t + 1);
          if (
            (await new Promise((h) => {
              const S = setTimeout(h, l),
                j = () => {
                  clearTimeout(S), h();
                };
...
function Gt(e) {
  let { config: r, facts: a, store: s, onSnapshot: i, onTimeTravel: o } = e,
    d = r.timeTravel ?? !1,
  ...
  return {
    ...
    takeSnapshot(B) {
      ...
      const p = { id: c++, timestamp: Date.now(), facts: D(), trigger: B };
      for (
        m < g.length - 1 && g.splice(m + 1), g.push(p), m = g.length - 1;
        g.length > u;
      )
        g.shift(), m--;
      return i?.(p), p;
    ...
    goBack(B = 1) {
      ...
      let p = m,
        x = m,
        v = A.find((k) => m > k.startIndex && m <= k.endIndex);
      if (v) x = v.startIndex;
      else if (A.find((k) => m === k.startIndex)) {
        const k = A.find((F) => F.endIndex < m && m - F.endIndex <= B);
        x = k ? k.startIndex : Math.max(0, m - B);
      } else x = Math.max(0, m - B);
      if (p === x) return;
      m = x;
      const $ = g[m];
      $ && (this.restore($), o?.(p, x));
    ...
    goForward(B = 1) {
      ...
      let p = m,
        x = m,
        v = A.find((k) => m >= k.startIndex && m < k.endIndex);
      if ((v ? (x = v.endIndex) : (x = Math.min(g.length - 1, m + B)), p === x))
        return;
      m = x;
      const $ = g[m];
      $ && (this.restore($), o?.(p, x));
    ...
    export() {
      return JSON.stringify({ version: 1, snapshots: g, currentIndex: m });
    },
    import(B) {
      if (d)
        try {
          ...
          (g.length = 0), g.push(...p.snapshots), (m = p.currentIndex);
          const x = g[m];
          x && this.restore(x);
        } catch (p) {
    ...
    endChangeset() {
      !d ||
        O === null ||
        (m > M && A.push({ label: O, startIndex: M, endIndex: m }),
        (O = null),
        (M = -1));
    },
    pause() {
...
function wt(e) {
  ...
  let E = Vt({
    ...
    { store: M, facts: R } = Bt({
      ...
      onChange: (t, n, l) => {
        c.emitFactSet(t, n, l),
          I(t),
          !O?.isRestoring && (g === 0 && (m = !0), w.changedKeys.add(t), T());
      },
      onBatch: (t) => {
        c.emitFactsBatch(t);
        const n = [];
  ...
  (I = (t) => D.invalidate(t)), (A = (t) => D.invalidateMany(t));
  const N = Ht({
      definitions: i,
      facts: R,
      store: M,
  ...
  async function P() {
    if (!w.isReconciling) {
      ...
      try {
        ...
        w.changedKeys.clear();
        const l = await B.evaluate(n),
          h = new Le();
        for (const _ of l) h.add(_), c.emitRequirementCreated(_);
        const { added: S, removed: j } = h.diff(w.previousRequirements);
        for (const _ of j) p.cancel(_.id);
        for (const _ of S) p.resolve(_);
        w.previousRequirements = h;
        const L = p.getInflightInfo(),
          W = {
            ...
            canceled: j.map((_) => ({
              id: _.id,
              resolverId: L.find((V) => V.id === _.id)?.resolverId ?? "unknown",
            })),
          };
        ...
        (w.isReconciling = !1),
          w.changedKeys.size > 0 ? T() : w.reconcileScheduled || (b = 0),
          F();
      }
    }
  }
  const H = new Proxy(
    ...
    z = new Proxy(
      {},
      {
        ...
        has(t, n) {
          return typeof n == "symbol" || ae.has(n) ? !1 : n in a;
        },
        ownKeys() {
          return Object.keys(a);
        },
        getOwnPropertyDescriptor(t, n) {
          if (typeof n != "symbol" && !ae.has(n) && n in a)
            return { configurable: !0, enumerable: !0 };
        },
      },
    ),
    y = {
      ...
      derive: H,
      events: z,
      constraints: { disable: (t) => B.disable(t), enable: (t) => B.enable(t) },
      effects: {
      ...
      subscribe(t, n) {
        const l = [],
          h = [];
        for (const j of t) j in s ? l.push(j) : j in r && h.push(j);
        const S = [];
        return (
          l.length > 0 && S.push(D.subscribe(l, n)),
          h.length > 0 && S.push(M.subscribe(h, n)),
          () => {
            for (const j of S) j();
          }
        );
      ...
      watch(t, n, l) {
        const h = l?.equalityFn
          ? (j, L) => l.equalityFn(j, L)
          : (j, L) => Object.is(j, L);
        if (t in s) {
          let j = D.get(t);
      ...
      inspect() {
        return {
          ...
          constraints: B.getAllStates().map((t) => ({
            id: t.id,
      ...
      explain(t) {
        ...
        if (!n) return null;
        const l = B.getState(n.fromConstraint),
          h = p.getStatus(t),
          S = {},
          j = M.toObject();
          ...
          _.length > 0 &&
            ...
            _.forEach(([V, J], re) => {
              const ee = re === _.length - 1 ? "   └─" : "   ├─",
                Q = typeof J == "object" ? JSON.stringify(J) : String(J);
              L.push(
                `${ee} ${V} = ${Q.slice(0, 50)}${Q.length > 50 ? "..." : ""}`,
              );
            })),
          L.join(`
`)
      ...
      getDistributableSnapshot(t = {}) {
        ...
        if (h && h.length > 0) {
          const ee = M.toObject();
          for (const Q of h) Q in ee && (W[Q] = ee[Q]);
        }
        const J = Date.now(),
      ...
      watchDistributableSnapshot(t, n) {
        let { includeDerivations: l, excludeDerivations: h } = t,
          S = Object.keys(s),
          j;
        if ((l ? (j = l.filter((W) => S.includes(W))) : (j = S), h)) {
          const W = new Set(h);
  ...
  function C(t) {
    ...
    Object.assign(r, t.schema),
      ...
      t.constraints &&
        (Object.assign(o, t.constraints), B.registerDefinitions(t.constraints)),
      t.resolvers &&
        (Object.assign(d, t.resolvers), p.registerDefinitions(t.resolvers)),
      M.registerKeys(t.schema),
      e.modules.push(t),
      t.init &&
        M.batch(() => {
          t.init(R);
      ...
      t.hooks?.onInit?.(y),
      w.isRunning && (t.hooks?.onStart?.(y), T());
  }
...
function Qt(e) {
  ...
  function d(u) {
    ...
    if (g?.crossModuleDeps)
      for (const m of Object.keys(g.crossModuleDeps)) r.includes(m) && d(m);
    o.pop(), s.delete(u), a.add(u), i.push(u);
  }
  for (const u of r) d(u);
  return i;
}
var Ze = new WeakMap(),
  et = new WeakMap(),
...
function er(e) {
  ...
  if (Array.isArray(o)) {
    ...
    i = p;
  } else o === "declaration" ? (i = Object.keys(r)) : (i = Qt(r));
  let d = e.debug,
    u = e.errorBoundary;
  e.zeroConfig &&
  ...
  for (const p of i) {
    ...
    const v = x.crossModuleDeps && Object.keys(x.crossModuleDeps).length > 0,
      ...
      k = {};
    for (const [y, C] of Object.entries(x.schema.facts)) k[`${p}${K}${y}`] = C;
    const F = {};
    ...
    if (x.resolvers)
      for (const [y, C] of Object.entries(x.resolvers)) {
        ...
        H[`${p}${K}${y}`] = {
          ...t,
          resolve: async (n, l) => {
            const h = Te(l.facts, r, () => Object.keys(r));
            await t.resolve(n, { facts: h[p], signal: l.signal });
          },
        };
      }
    const z = {};
    if (x.effects)
      for (const [y, C] of Object.entries(x.effects)) {
        ...
        z[`${p}${K}${y}`] = {
          ...t,
          run: (n, l) => {
            const h = v ? ce(n, p, $) : se(n, p),
              S = l ? (v ? ce(l, p, $) : se(l, p)) : void 0;
            return t.run(h, S);
          },
          deps: t.deps?.map((n) => `${p}${K}${n}`),
        };
    ...
    g.push({
      ...
      hooks: x.hooks,
      snapshotEvents:
        s && !s.has(p) ? [] : x.snapshotEvents?.map((y) => `${p}${K}${y}`),
    });
  }
  let m = null,
    c = null;
  ...
  return {
    ...
    getDistributableSnapshot(p) {
      const x = {
        ...
        $ = {};
      for (const [k, F] of Object.entries(v.data)) {
        const f = k.indexOf(K);
        if (f > 0) {
          const b = k.slice(0, f),
            w = k.slice(f + K.length);
          $[b] || ($[b] = {}), ($[b][w] = F);
        } else $._root || ($._root = {}), ($._root[k] = F);
      }
      return { ...v, data: $ };
    },
    watchDistributableSnapshot(p, x) {
      ...
      return c.watchDistributableSnapshot(v, ($) => {
        const k = {};
        for (const [F, f] of Object.entries($.data)) {
          const b = F.indexOf(K);
          if (b > 0) {
            const w = F.slice(0, b),
              T = F.slice(b + K.length);
            k[w] || (k[w] = {}), (k[w][T] = f);
          } else k._root || (k._root = {}), (k._root[F] = f);
        }
        x({ ...$, data: k });
      });
    },
    registerModule(p, x) {
      ...
      if (v.effects)
        for (const [y, C] of Object.entries(v.effects)) {
          ...
          H[`${p}${K}${y}`] = {
            ...t,
            run: (n, l) => {
              const h = $ ? ce(n, p, k) : se(n, p),
                S = l ? ($ ? ce(l, p, k) : se(l, p)) : void 0;
              return t.run(h, S);
            },
            deps: t.deps?.map((n) => `${p}${K}${n}`),
          };
        }
      a.add(p), (r[p] = v), (A.names = null);
      const z = [];
      ...
      I.set(p, z),
        c.registerModule({
          ...
          constraints: Object.keys(T).length > 0 ? T : void 0,
          resolvers: Object.keys(P).length > 0 ? P : void 0,
          hooks: v.hooks,
          snapshotEvents:
            s && !s.has(p) ? [] : v.snapshotEvents?.map((y) => `${p}${K}${y}`),
        });
    },
  };
}
...
var nt = new WeakMap();
function ce(e, r, a) {
  let s = `${r}:${JSON.stringify([...a].sort())}`,
    i = nt.get(e);
  if (i) {
    const g = i.get(s);
    if (g) return g;
  } else (i = new Map()), nt.set(e, i);
  const o = new Set(a),
    d = ["self", ...a],
    u = new Proxy(
      {},
...
function nr(e) {
  ...
  o = wt({
    ...
    onAfterModuleInit: () => {
      ...
      if (i) {
        for (const [m, c] of Object.entries(i)) ne.has(m) || (o.facts[m] = c);
        i = null;
      }
    },
  });
...
function ar() {
  return { entries: new St(lr), inflight: new Map() };
}
function cr() {
  return {
...
function pr(e, r, a, s) {
  ...
  function N(U, Y) {
    ...
    const Ke = document.createElement("thead"),
      Ue = document.createElement("tr");
    for (const Mt of ["Key", "Value"]) {
    ...
    Ke.appendChild(Ue), de.appendChild(Ke);
    const Ve = document.createElement("tbody");
    return (
      de.appendChild(Ve),
      X.appendChild(de),
      { details: X, tbody: Ve, countSpan: fe }
    );
  }
  function B(U, Y) {
    const X = document.createElement("details");
    ...
    return (
      ...
      X.appendChild(de),
      { details: X, list: de, countSpan: fe }
    );
  }
  const p = N("Facts", !0);
  ...
  T.setAttribute("width", "100%"),
    ...
    T.setAttribute("aria-label", "System dependency graph"),
    (T.style.display = "block"),
    T.setAttribute("viewBox", "0 0 460 120"),
    T.setAttribute("preserveAspectRatio", "xMinYMin meet"),
    b.appendChild(T),
    g.appendChild(b);
  ...
  Object.assign(j.style, {
    ...
    g.addEventListener(
      ...
      (U) => {
        const Y = g,
          X = Y.scrollTop === 0 && U.deltaY < 0,
          le = Y.scrollTop + Y.clientHeight >= Y.scrollHeight && U.deltaY > 0;
        (X || le) && U.preventDefault();
      },
      { passive: !1 },
    );
  let L = a,
  ...
  u.addEventListener("click", _), E.addEventListener("click", V);
  function J(U) {
    U.key === "Escape" && L && V();
  }
...
function ke(e, r, a, s, i, o) {
  let d = Et(s),
    u = e.get(a);
  if (u) {
    const g = u.cells;
    if (g[1] && ((g[1].textContent = d), i && o)) {
      const m = g[1];
    ...
    (u = document.createElement("tr")),
      (u.style.borderBottom = `1px solid ${q.rowBorder}`);
    const g = document.createElement("td");
    Object.assign(g.style, { padding: "2px 4px", color: q.muted }),
      (g.textContent = a);
...
function at(e, r, a, s) {
  ...
  const o = new Set(i);
  for (const [d, u] of r) o.has(d) || (u.remove(), r.delete(d));
  for (const d of i) {
    let u;
    try {
      u = Et(a.read(d));
...
function hr(e, r, a, s) {
  ...
  (m.style.color = q.closeBtn), (m.textContent = u);
  ...
  for (
    ...
    e.eventsList.childElementCount > mr;
  )
  ...
  if (r.resolverStats.size > 0) {
    ...
    for (const [d, u] of o) {
      ...
      (m.style.paddingLeft = "8px"),
        (m.textContent = `${d}: ${u.count}x, avg ${g}ms${u.errors > 0 ? `, ${u.errors} err` : ""}`),
        u.errors > 0 && (m.style.color = q.red),
...
var _e = new WeakMap();
function br(e, r, a, s, i, o) {
  return [
    e.join(","),
    r.join(","),
    a.map((d) => `${d.id}:${d.active}`).join(","),
    [...s.entries()].map(([d, u]) => `${d}:${u.status}:${u.type}`).join(","),
    i.join(","),
    o.join(","),
  ].join("|");
}
function wr(e, r, a, s, i) {
  for (const o of a) {
    const d = e.nodes.get(`0:${o}`);
    if (!d) continue;
    const u = r.recentlyChangedFacts.has(o);
    d.rect.setAttribute("fill", u ? q.text + "33" : "none"),
      d.rect.setAttribute("stroke-width", u ? "2" : "1");
  }
  for (const o of s) {
    const d = e.nodes.get(`1:${o}`);
    if (!d) continue;
    const u = r.recentlyComputedDerivations.has(o);
    d.rect.setAttribute("fill", u ? q.accent + "33" : "none"),
      d.rect.setAttribute("stroke-width", u ? "2" : "1");
  }
  for (const o of i) {
    const d = e.nodes.get(`2:${o}`);
    if (!d) continue;
    const u = r.recentlyActiveConstraints.has(o),
      g = d.rect.getAttribute("stroke") ?? q.muted;
...
function ut(e, r, a) {
  ...
  const O = Z.nodeW + Z.colGap,
    M = [5, 5 + O, 5 + O * 2, 5 + O * 3, 5 + O * 4],
    R = M[4] + Z.nodeW + 5;
  function D(y) {
    let C = Z.startY + 12;
    return y.map((t) => {
      const n = { ...t, y: C };
      return (C += Z.nodeH + Z.nodeGap), n;
    });
  }
  const N = D(i.map((y) => ({ id: y, label: pe(y, Z.labelMaxChars) }))),
    B = D(o.map((y) => ({ id: y, label: pe(y, Z.labelMaxChars) }))),
    p = D(
      d.map((y) => ({
        id: y.id,
        label: pe(y.id, Z.labelMaxChars),
        active: y.active,
        priority: y.priority,
      })),
    ),
    ...
    v = D(m.map((y) => ({ id: y, label: pe(y, Z.labelMaxChars) }))),
    $ = Math.max(N.length, B.length, p.length, x.length, v.length, 1),
    k = Z.startY + 12 + $ * (Z.nodeH + Z.nodeGap) + 8;
  e.flowSvg.replaceChildren(),
    e.flowSvg.setAttribute("viewBox", `0 0 ${R} ${k}`),
    e.flowSvg.setAttribute(
      "aria-label",
      `Dependency graph: ${i.length} facts, ${o.length} derivations, ${d.length} constraints, ${c.size} requirements, ${m.length} resolvers`,
    );
  const F = ["Facts", "Derivations", "Constraints", "Reqs", "Resolvers"];
  for (const [y, C] of F.entries()) {
    const t = document.createElementNS("http://www.w3.org/2000/svg", "text");
    t.setAttribute("x", String(M[y] ?? 0)),
      t.setAttribute("y", "10"),
  ...
  function b(y, C, t, n, l, h, S, j) {
    ...
    W.setAttribute("x", String(C)),
      ...
      W.setAttribute("rx", "3"),
      W.setAttribute("fill", j ? h + "33" : "none"),
    ...
    return (
      ...
      f.nodes.set(`${y}:${n}`, { g: L, rect: W, text: _ }),
      { midX: C + Z.nodeW / 2, midY: t }
    );
  }
  function w(y, C, t, n, l, h) {
  ...
  for (const y of N) {
    const C = a.recentlyChangedFacts.has(y.id),
      t = b(0, M[0], y.y, y.id, y.label, q.text, !1, C);
    T.set(y.id, t);
  }
  for (const y of B) {
    const C = a.recentlyComputedDerivations.has(y.id),
      t = b(1, M[1], y.y, y.id, y.label, q.accent, !1, C);
    P.set(y.id, t);
  }
  for (const y of p) {
  ...
  for (const y of x) {
    const C = y.status === "unmet" ? q.red : q.yellow,
      t = b(3, M[3], y.y, y.id, pe(y.type, Z.labelMaxChars), C, !1, !1);
    z.set(y.id, t);
  }
  for (const y of v) {
    const C = g.some((t) => t.resolverId === y.id);
    b(4, M[4], y.y, y.id, y.label, C ? q.green : q.muted, !C, !1);
  }
  for (const y of B) {
  ...
  for (const y of x) {
    ...
    C &&
      t &&
      w(C.midX + Z.nodeW / 2, C.midY, t.midX - Z.nodeW / 2, t.midY, q.muted);
  }
  for (const y of g) {
    const C = z.get(y.id);
    if (C) {
      const t = v.find((n) => n.id === y.resolverId);
      t && w(C.midX + Z.nodeW / 2, C.midY, M[4], t.y, q.green);
    }
  }
  _e.set(e.flowSvg, f);
}
...
function Er(e, r) {
  ...
  const d = i - s || 1,
    ...
    m = new Set();
  for (const A of a)
    m.has(A.resolver) || (m.add(A.resolver), g.push(A.resolver));
  for (const A of r.inflight.keys()) m.has(A) || (m.add(A), g.push(A));
  const c = g.slice(-12),
    E = he * c.length + 20;
  ...
  for (let A = 0; A <= I; A++) {
    ...
    R.setAttribute("x", String(O)),
      R.setAttribute("y", "8"),
      R.setAttribute("fill", q.muted),
      R.setAttribute("font-size", "6"),
      R.setAttribute("font-family", q.font),
      R.setAttribute("text-anchor", "middle"),
      (R.textContent =
        M < 1e3 ? `${M.toFixed(0)}ms` : `${(M / 1e3).toFixed(1)}s`),
      e.timelineSvg.appendChild(R);
    const D = document.createElementNS("http://www.w3.org/2000/svg", "line");
    D.setAttribute("x1", String(O)),
      D.setAttribute("y1", "10"),
      D.setAttribute("x2", String(O)),
      D.setAttribute("y2", String(E)),
      D.setAttribute("stroke", q.border),
          ...
          if (!i) {
            let o = !1,
              d = setInterval(() => {
                ...
                g && !o && ((o = !0), g.subscribers.add(a));
              }, 100),
              u = setTimeout(() => clearInterval(d), 1e4);
            return () => {
              clearInterval(d), clearTimeout(u);
              for (const g of e.values()) g.subscribers.delete(a);
            };
          }
          return (
            i.subscribers.add(a),
...
function $r(e = {}) {
  ...
  g.systems.set(r, m);
  let c = (n, l) => {
      const h = { timestamp: Date.now(), type: n, data: l };
      a && m.events.push(h);
    ...
    R = fr(),
    D = ar(),
    N = i && typeof window < "u" && typeof document < "u" && He(),
    B = null,
    p = 0,
    x = 1,
    v = 2,
  ...
  function y() {
    ...
    const n = E.refs,
      ...
      h = p;
    if (((p = 0), h & x)) {
      for (const S of P) gr(I, S);
      P.clear();
      for (const [S, { value: j, flash: L }] of T)
        ke(I, n.factsBody, S, j, L, E.flashTimers);
      T.clear(), (n.factsCount.textContent = String(I.size));
    }
    if ((h & v && at(n, A, l, E.flashTimers), h & k))
      if (H) Be(n, H.inflight.length, H.unmet.length);
      else {
        const S = Re(l);
        S && Be(n, S.inflight.length, S.unmet.length);
      }
    if (h & $)
      if (H) qe(n, H.inflight, H.unmet);
      else {
        const S = Re(l);
        S && qe(n, S.inflight, S.unmet);
      }
    h & F && yr(n, O),
      h & f && ut(n, l, M),
      h & b && ct(n, l),
  ...
  function C(n, l) {
    E && a && hr(E.refs, n, l, m.events.size);
  }
  function t(n, l) {
    R.isRecording &&
      R.recordedEvents.length < ur &&
      R.recordedEvents.push({ timestamp: Date.now(), type: n, data: ir(l) });
  }
  return {
    name: "devtools",
    onInit: (n) => {
      if (
        ...
        try {
          ...
          for (const [L, W] of Object.entries(j)) ke(I, h.factsBody, L, W, !1);
          h.factsCount.textContent = String(Object.keys(j).length);
        } catch {}
        at(h, A, l);
        const S = Re(l);
        S &&
          (Be(h, S.inflight.length, S.unmet.length),
          qe(h, S.inflight, S.unmet)),
          ct(h, l),
          vr(h, l),
          ut(h, l, M),
          h.recordBtn.addEventListener("click", () => {
            if (
              ...
              (h.recordBtn.textContent = R.isRecording ? "⏹ Stop" : "⏺ Record"),
              (h.recordBtn.style.color = R.isRecording ? q.red : q.text),
              R.isRecording)
            ) {
    ...
    onDestroy: (n) => {
      c("destroy", {}),
        ...
        M.animationTimer && clearTimeout(M.animationTimer),
        E && (E.destroy(), (E = null), I.clear(), A.clear());
    },
    onFactSet: (n, l, h) => {
      c("fact.set", { key: n, value: l, prev: h }),
        t("fact.set", { key: n, value: l, prev: h }),
        M.recentlyChangedFacts.add(n),
        E &&
          m.system &&
          (T.set(n, { value: l, flash: !0 }),
          P.delete(n),
          z(x),
    ...
    onFactDelete: (n, l) => {
      c("fact.delete", { key: n, prev: l }),
        ...
        E && (P.add(n), T.delete(n), z(x), C("fact.delete", { key: n }));
    },
    onFactsBatch: (n) => {
      if (
        ...
        for (const l of n)
          l.type === "delete"
            ? (P.add(l.key), T.delete(l.key))
            : (M.recentlyChangedFacts.add(l.key),
              T.set(l.key, { value: l.value, flash: !0 }),
              P.delete(l.key));
        z(x), C("facts.batch", { count: n.length });
      }
    },
    onDerivationCompute: (n, l, h) => {
      c("derivation.compute", { id: n, value: l, deps: h }),
        t("derivation.compute", { id: n, deps: h }),
        M.derivationDeps.set(n, h),
        M.recentlyComputedDerivations.add(n),
    ...
    onReconcileEnd: (n) => {
      ...
      if (R.isRecording && m.system && R.snapshots.length < dr)
        try {
          R.snapshots.push({
            timestamp: Date.now(),
    ...
    onConstraintEvaluate: (n, l) => {
      c("constraint.evaluate", { id: n, active: l }),
        ...
        l
          ? (M.activeConstraints.add(n), M.recentlyActiveConstraints.add(n))
          : M.activeConstraints.delete(n),
        C("constraint.evaluate", { id: n, active: l });
    },
    ...
    onResolverComplete: (n, l, h) => {
      c("resolver.complete", { resolver: n, requirementId: l.id, duration: h }),
        t("resolver.complete", {
          resolver: n,
          requirementId: l.id,
          duration: h,
        });
      const S = O.resolverStats.get(n) ?? { count: 0, totalMs: 0, errors: 0 };
      if (
        (S.count++,
        (S.totalMs += h),
        O.resolverStats.set(n, S),
        O.resolverStats.size > lt)
      ) {
        const L = O.resolverStats.keys().next().value;
        L !== void 0 && O.resolverStats.delete(L);
      }
      const j = D.inflight.get(n);
      D.inflight.delete(n),
        j !== void 0 &&
          D.entries.push({
            resolver: n,
    ...
    onResolverError: (n, l, h) => {
      ...
      const S = O.resolverStats.get(n) ?? { count: 0, totalMs: 0, errors: 0 };
      if ((S.errors++, O.resolverStats.set(n, S), O.resolverStats.size > lt)) {
        const L = O.resolverStats.keys().next().value;
        L !== void 0 && O.resolverStats.delete(L);
      }
      const j = D.inflight.get(n);
    ...
    onResolverRetry: (n, l, h) => {
      c("resolver.retry", { resolver: n, requirementId: l.id, attempt: h }),
        t("resolver.retry", { resolver: n, requirementId: l.id, attempt: h }),
    ...
    onTimeTravel: (n, l) => {
      if (
        ...
        try {
          ...
          I.clear(), E.refs.factsBody.replaceChildren();
          for (const [j, L] of Object.entries(S))
            ke(I, E.refs.factsBody, j, L, !1);
          E.refs.factsCount.textContent = String(Object.keys(S).length);
        } catch {}
        A.clear(),
          M.derivationDeps.clear(),
...
const Cr = [
  ...
  Ar = ["Alice", "Bob", "Carol", "Dan", "Eve", "Server"];
function $e(e) {
...
class Dr {
  constructor(r, a, s) {
    if (((this.failRate = a), (this.messageRateMs = s), !r))
      throw new Error("WebSocket URL is required");
    const i = 300 + Math.random() * 300;
    this.connectTimer = setTimeout(() => {
      if (((this.connectTimer = null), !this.closed)) {
        if (Mr(this.failRate)) {
          this.onerror?.(new Error("Connection failed: server unreachable"));
          return;
        }
        this.onopen?.(), this.startMessages();
      }
    }, i);
  }
  onopen = null;
  ...
  close() {
    this.closed ||
      ...
      this.messageTimer !== null &&
        (clearInterval(this.messageTimer), (this.messageTimer = null)),
      this.onclose?.());
  }
  startMessages() {
    this.messageTimer = setInterval(() => {
      ...
      ve++;
      const a = ["system", "chat", "data"][ve % 3];
      let s, i;
      a === "system"
        ? ((s = $e(Cr)), (i = "Server"))
        : a === "chat"
          ? ((s = $e(Rr)), (i = $e(Ar.filter((o) => o !== "Server"))))
          : ((s = $e(kr)()), (i = "Monitor")),
        this.onmessage?.({
          id: `msg-${ve}`,
          type: a,
...
const Pe = {
  facts: {
    url: G.string(),
    status: G.string(),
    connectRequested: G.boolean(),
    messages: G.object(),
    retryCount: G.number(),
    maxRetries: G.number(),
    messageToSend: G.string(),
    now: G.number(),
    reconnectTargetTime: G.number(),
    messageRate: G.number(),
    connectFailRate: G.number(),
    reconnectFailRate: G.number(),
    eventLog: G.object(),
  },
  derivations: {
    isConnected: G.boolean(),
    shouldReconnect: G.boolean(),
    reconnectDelay: G.number(),
    reconnectCountdown: G.number(),
    canSend: G.boolean(),
    messageCount: G.number(),
  },
  events: {
    requestConnect: {},
    disconnect: {},
    setMessageToSend: { value: G.string() },
    messageSent: {},
    setUrl: { value: G.string() },
    setMessageRate: { value: G.number() },
    setConnectFailRate: { value: G.number() },
    setReconnectFailRate: { value: G.number() },
    setMaxRetries: { value: G.number() },
    tick: {},
    clearMessages: {},
    forceError: {},
  },
  requirements: {
    ...
    RECONNECT: { delay: G.number(), reconnectFailRate: G.number() },
  },
};
function me(e, r, a) {
  const s = [...e.eventLog];
  s.push({ timestamp: Date.now(), event: r, detail: a }),
    s.length > 100 && s.splice(0, s.length - 100),
    (e.eventLog = s);
}
const jr = _t("websocket", {
    schema: Pe,
    init: (e) => {
      (e.url = "wss://demo.directive.run/chat"),
        (e.status = "disconnected"),
        (e.connectRequested = !1),
        (e.messages = []),
        (e.retryCount = 0),
        (e.maxRetries = 5),
        (e.messageToSend = ""),
        (e.now = Date.now()),
        (e.reconnectTargetTime = 0),
        (e.messageRate = 3),
        (e.connectFailRate = 0),
        (e.reconnectFailRate = 0),
        (e.eventLog = []);
    },
    derive: {
      isConnected: (e) => e.status === "connected",
      shouldReconnect: (e) =>
        e.status === "error" &&
        e.retryCount < e.maxRetries &&
        e.connectRequested,
      reconnectDelay: (e) => Math.min(1e3 * 2 ** e.retryCount, 3e4),
      reconnectCountdown: (e) =>
        e.reconnectTargetTime <= 0
          ? 0
          : Math.max(0, Math.ceil((e.reconnectTargetTime - e.now) / 1e3)),
      canSend: (e) => e.status === "connected" && e.messageToSend.trim() !== "",
      messageCount: (e) => e.messages.length,
    },
    events: {
      requestConnect: (e) => {
        (e.connectRequested = !0),
          (e.status = "connecting"),
          (e.retryCount = 0),
          (e.reconnectTargetTime = 0),
          (e.messages = []),
      ...
      setMessageRate: (e, { value: r }) => {
        e.messageRate = r;
      },
      setConnectFailRate: (e, { value: r }) => {
        e.connectFailRate = r;
      },
      setReconnectFailRate: (e, { value: r }) => {
        e.reconnectFailRate = r;
      },
      setMaxRetries: (e, { value: r }) => {
        e.maxRetries = r;
      },
      tick: (e) => {
        e.now = Date.now();
    ...
    constraints: {
      needsConnection: {
        priority: 100,
        when: (e) => e.connectRequested && e.status === "connecting",
        require: (e) => ({
          type: "CONNECT",
          url: e.url,
          messageRate: e.messageRate,
          connectFailRate: e.connectFailRate,
        }),
      },
      needsReconnect: {
        priority: 90,
        ...
        require: (e) => ({
          type: "RECONNECT",
          delay: Math.min(1e3 * 2 ** e.retryCount, 3e4),
          reconnectFailRate: e.reconnectFailRate,
        }),
      },
    },
    resolvers: {
      connect: {
        ...
        timeout: 1e4,
        resolve: async (e, r) => {
          me(r.facts, "connect", `Connecting to ${e.url}...`),
            oe && (oe.close(), (oe = null));
          try {
            const a = new Dr(e.url, e.connectFailRate, e.messageRate * 1e3);
            oe = a;
            const s = a;
            (a.onmessage = (i) => {
              if (oe !== s) return;
              const o = [...r.facts.messages];
              o.push(i),
              ...
              (a.onclose = () => {
                oe === s &&
                  ((r.facts.status = "disconnected"),
                  (oe = null),
                  me(r.facts, "close", "Connection closed"));
              }),
              (a.onerror = (i) => {
                oe === s &&
                  ((r.facts.status = "error"),
                  (oe = null),
                  me(r.facts, "error", i.message));
              }),
              ...
              (r.facts.status = "connected"),
              (r.facts.retryCount = 0),
              (r.facts.reconnectTargetTime = 0),
              me(r.facts, "connected", "Connection established");
          } catch (a) {
            const s = a instanceof Error ? a.message : "Unknown error";
            throw (
              ((r.facts.status = "error"),
              (oe = null),
              me(r.facts, "connect-error", s),
              a)
            );
          }
        },
      ...
      reconnect: {
        ...
        timeout: 6e4,
        resolve: async (e, r) => {
          const a = r.facts.retryCount;
          (r.facts.status = "reconnecting"),
            (r.facts.reconnectTargetTime = Date.now() + e.delay),
            me(
              r.facts,
              "reconnect",
              `Waiting ${(e.delay / 1e3).toFixed(1)}s (attempt ${a + 1})...`,
            ),
            await new Promise((s) => setTimeout(s, e.delay)),
            (r.facts.retryCount = a + 1),
            (r.facts.reconnectTargetTime = 0),
            (r.facts.status = "connecting");
        },
      },
    },
    effects: {
      logStatusChange: {
        ...
        run: (e, r) => {
          r &&
            r.status !== e.status &&
            me(e, "status", `${r.status} → ${e.status}`);
        },
      },
    },
  }),
  ie = Zt({ module: jr, plugins: [$r({ name: "websocket" })] });
ie.start();
const Ir = [...Object.keys(Pe.facts), ...Object.keys(Pe.derivations)],
  dt = document.getElementById("ws-status-badge"),
  Tr = document.getElementById("ws-url-display"),
  ft = document.getElementById("ws-reconnect-area"),
  qr = document.getElementById("ws-reconnect-countdown"),
  We = document.getElementById("ws-url-input"),
  xt = document.getElementById("ws-connect-btn"),
  $t = document.getElementById("ws-disconnect-btn"),
  Ct = document.getElementById("ws-force-error-btn"),
  Oe = document.getElementById("ws-message-input"),
  Rt = document.getElementById("ws-send-btn"),
  Br = document.getElementById("ws-clear-btn"),
  je = document.getElementById("ws-connect-error"),
  be = document.getElementById("ws-message-feed"),
  _r = document.getElementById("ws-message-footer"),
  mt = document.getElementById("ws-message-rate"),
  Fr = document.getElementById("ws-rate-val"),
  pt = document.getElementById("ws-connect-failrate"),
  zr = document.getElementById("ws-connect-fail-val"),
  gt = document.getElementById("ws-reconnect-failrate"),
  Lr = document.getElementById("ws-reconnect-fail-val"),
  ht = document.getElementById("ws-max-retries"),
  Nr = document.getElementById("ws-max-retries-val"),
  Fe = document.getElementById("ws-timeline");
let yt = 0,
  Ie = "";
function kt() {
  const e = ie.facts,
    ...
    s = e.url,
    i = e.messages,
    o = r.reconnectCountdown,
    d = r.canSend,
    u = r.messageCount,
    g = e.eventLog;
  (dt.textContent = a),
    (dt.className = `ws-status-badge ${a}`),
    (Tr.textContent = s),
    a === "reconnecting" && o > 0
      ? ((ft.style.display = "flex"),
        (qr.textContent = `Reconnecting in ${o}s...`))
      : (ft.style.display = "none"),
    (xt.disabled =
      a === "connected" || a === "connecting" || a === "reconnecting"),
    ($t.disabled = a === "disconnected"),
    (Ct.disabled = a !== "connected"),
    (Rt.disabled = !d);
  const m = g
      .slice()
      .reverse()
  ...
  if (
    ...
    for (const E of i) {
      const I = document.createElement("div"),
        A = E.from === "You";
      (I.className = `ws-message-item ${A ? "" : E.type}`),
        A && (I.style.borderLeft = "3px solid var(--brand-text-dim)");
      const M = new Date(E.timestamp).toLocaleTimeString([], {
        hour: "2-digit",
        minute: "2-digit",
        second: "2-digit",
      });
      (I.innerHTML = `
        <span class="ws-msg-type ${E.type}">${we(A ? "echo" : E.type)}</span>
        <span class="ws-msg-from">${we(E.from)}</span>
        <span class="ws-msg-text">${we(E.text)}</span>
        <span class="ws-msg-time">${M}</span>
      `),
        be.appendChild(I);
    }
    i.length > yt && (be.scrollTop = be.scrollHeight);
  }
  if (
    ((yt = i.length),
    (_r.textContent = `${u} message${u !== 1 ? "s" : ""}`),
    (Fr.textContent = `${e.messageRate}s`),
    (zr.textContent = `${e.connectFailRate}%`),
    (Lr.textContent = `${e.reconnectFailRate}%`),
    (Nr.textContent = `${e.maxRetries}`),
    g.length === 0)
  )
    Fe.innerHTML =
    ...
    for (let E = g.length - 1; E >= 0; E--) {
      ...
      A.className = `ws-timeline-entry ${I.event}`;
      const M = new Date(I.timestamp).toLocaleTimeString([], {
        hour: "2-digit",
        minute: "2-digit",
        second: "2-digit",
      });
      (A.innerHTML = `
        <span class="ws-timeline-time">${M}</span>
        <span class="ws-timeline-event">${we(I.event)}</span>
        <span class="ws-timeline-detail">${we(I.detail)}</span>
      `),
        Fe.appendChild(A);
    }
  }
...
xt.addEventListener("click", () => {
  je.classList.remove("visible"), (Ie = ""), ie.events.requestConnect();
});
$t.addEventListener("click", () => {
  je.classList.remove("visible"), (Ie = ""), ie.events.disconnect();
});
Ct.addEventListener("click", () => {
  ie.events.forceError();
});
We.addEventListener("input", () => {
  ie.events.setUrl({ value: We.value });
});
Oe.addEventListener("input", () => {
  ie.events.setMessageToSend({ value: Oe.value });
});
Oe.addEventListener("keydown", (e) => {
  e.key === "Enter" && (e.preventDefault(), At());
});
function At() {
  const e = Or(),
    r = ie.facts.messageToSend.trim();
  !e || !r || (e.send(r), ie.events.messageSent(), (Oe.value = ""));
}
Rt.addEventListener("click", At);
Br.addEventListener("click", () => {
  ie.events.clearMessages();
});
mt.addEventListener("input", () => {
  ie.events.setMessageRate({ value: Number(mt.value) });
});
pt.addEventListener("input", () => {
  ie.events.setConnectFailRate({ value: Number(pt.value) });
});
gt.addEventListener("input", () => {
  ie.events.setReconnectFailRate({ value: Number(gt.value) });
});
ht.addEventListener("input", () => {
  ie.events.setMaxRetries({ value: Number(ht.value) });
});
function we(e) {
