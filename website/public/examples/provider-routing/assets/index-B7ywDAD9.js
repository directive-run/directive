...
function Oe(e = [], r, l, s, i, o) {
  return {
    ...
    _refinements: o,
    validate(f) {
      return Oe([...e, f], r, l, s, i, o);
    },
  };
}
function te(e, r, l, s, i, o) {
  return {
    ...Oe(e, r, l, s, i, o),
    default(f) {
      return te(e, r, f, s, i, o);
    },
    transform(f) {
      return te(
        [],
    ...
    brand() {
      return te(e, `Branded<${r}>`, l, s, i, o);
    },
    describe(f) {
      return te(e, r, l, s, f, o);
    },
    refine(f, d) {
      const g = [...(o ?? []), { predicate: f, message: d }];
      return te([...e, f], r, l, s, i, g);
    },
    nullable() {
      return te(
        [(f) => f === null || e.every((d) => d(f))],
        `${r} | null`,
        l,
        s,
        i,
...
var oe = {
  ...
  array() {
    const e = (r, l, s, i, o) => {
      ...
      return {
        ...
        nonEmpty() {
          return e([...r, (g) => g.length > 0], l, s, i, d);
        },
        maxLength(g) {
          return e([...r, (p) => p.length <= g], l, s, i, d);
        },
        minLength(g) {
          return e([...r, (p) => p.length >= g], l, s, i, d);
        },
  ...
  object() {
    const e = (r, l, s) => ({
      ...
      nonNull() {
        return e([...r, (i) => i != null], l, s);
      },
      hasKeys(...i) {
        return e([...r, (o) => i.every((f) => f in o)], l, s);
      },
      default(i) {
        return e(r, i, s);
      },
  ...
  union(...e) {
    const r = e.map((l) => l._typeName ?? "unknown");
    return te(
...
function Ct(e) {
  const { schema: r, onChange: l, onBatch: s } = e;
  ...
  function m(u, b) {
    ...
    if (!w) {
      if (o)
        throw new Error(
          `[Directive] Unknown fact key: "${u}". Key not defined in schema.`,
        );
      console.warn(`[Directive] Unknown fact key: "${u}"`);
      return;
    }
    if (D(w)) {
      ...
      if (!z.success) {
        const v = b === null ? "null" : Array.isArray(b) ? "array" : typeof b,
          ...
          n = L(w);
        throw new Error(
          `[Directive] Validation failed for "${u}": expected ${n}, got ${v} ${k}. ${t}`,
        );
      }
      return;
    }
    ...
    for (let z = 0; z < F.length; z++) {
      ...
      if (typeof v == "function" && !v(b)) {
        ...
        throw new Error(
          `[Directive] Validation failed for "${u}": expected ${H}, got ${k} ${t}${a}${n}`,
        );
      }
    }
  }
  ...
  function C(u, b, w) {
    ...
    try {
      ...
      while (O.length > 0) {
        ...
        const F = [...O];
        O.length = 0;
        for (const H of F) l?.(H.key, H.value, H.prev), $(H.key);
        y();
      }
    } finally {
      j = !1;
      ...
      if ((s && T.length > 0 && s([...T]), A.size > 0)) {
        ...
        try {
          ...
          while (O.length > 0) {
            ...
            const b = [...O];
            O.length = 0;
            for (const w of b) l?.(w.key, w.value, w.prev), $(w.key);
            y();
          }
        } finally {
          j = !1;
  ...
  const P = {
    ...
    set(u, b) {
      ...
      Object.is(w, b) ||
        ...
        g.add(u),
        E > 0
          ? (T.push({ key: u, value: b, prev: w, type: "set" }), A.add(u))
          : C(u, b, w));
    },
    delete(u) {
      const b = d.get(u);
      d.delete(u),
        g.delete(u),
        E > 0
          ? (T.push({ key: u, value: void 0, prev: b, type: "delete" }),
            A.add(u))
          : C(u, void 0, b);
    },
    batch(u) {
    ...
    subscribeAll(u) {
      return c.add(u), () => c.delete(u);
    },
    toObject() {
      const u = {};
      for (const b of g) d.has(b) && (u[b] = d.get(b));
      return u;
    },
  };
  return (
    (P.registerKeys = (u) => {
      for (const b of Object.keys(u)) Se.has(b) || ((r[b] = u[b]), g.add(b));
    }),
    P
  );
}
  ...
  return new Proxy(
    {},
    {
      get(s, i) {
        ...
        if (typeof i != "symbol" && !Se.has(i)) return e.get(i);
      },
      set(s, i, o) {
...
function Rt(e) {
  const r = Ct(e),
    l = kt(r, e.schema);
  return { store: r, facts: l };
}
function Ot(e, r) {
  const l = "crossModuleDeps" in r ? r.crossModuleDeps : void 0;
  return {
    id: e,
    schema: r.schema,
    init: r.init,
...
async function xe(e, r, l) {
  let s,
    i = new Promise((o, f) => {
      s = setTimeout(() => f(new Error(l)), r);
    });
  try {
...
function $e(e, r = 50) {
  ...
  function i(o, f) {
    ...
    if ((s.add(d), Array.isArray(d))) {
      for (const g of d) if (!i(g, f + 1)) return s.delete(d), !1;
      return s.delete(d), !0;
    }
    for (const g of Object.keys(d))
      if (l.has(g) || !i(d[g], f + 1)) return s.delete(d), !1;
    return s.delete(d), !0;
  }
  return i(e, 0);
}
function Dt(e) {
  let r = mt(e),
    l = 5381;
  for (let s = 0; s < r.length; s++) l = ((l << 5) + l) ^ r.charCodeAt(s);
...
function jt(e, r, l) {
  return { requirement: e, id: At(e, l), fromConstraint: r };
}
var Pe = class ht {
    map = new Map();
    add(r) {
    ...
    clone() {
      const r = new ht();
      for (const l of this.map.values()) r.add(l);
      return r;
    }
    diff(r) {
      const l = [],
        s = [],
        i = [];
      for (const o of this.map.values()) r.has(o.id) ? i.push(o) : l.push(o);
...
function It(e) {
    ...
    for (const [t, n] of Object.entries(r))
      if (n.after)
        for (const a of n.after)
          r[a] && (L.has(a) || L.set(a, new Set()), L.get(a).add(t));
  }
  function y() {
    const t = new Set(),
      n = new Set(),
    ...
    function h(S, M) {
      ...
      n.add(S), M.push(S);
      const N = r[S];
      if (N?.after) for (const W of N.after) r[W] && h(W, M);
      M.pop(), n.delete(S), t.add(S), a.push(S);
    }
    for (const S of Object.keys(r)) h(S, []);
    (q = a), (m = new Map(q.map((S, M) => [S, M])));
  }
  y(), $();
  function C(t, n) {
  ...
  function u(t, n) {
    const a = c.get(t) ?? new Set();
    for (const h of a) {
      const S = E.get(h);
      S?.delete(t), S && S.size === 0 && E.delete(h);
    }
    for (const h of n) E.has(h) || E.set(h, new Set()), E.get(h).add(t);
    c.set(t, n);
  }
  function b(t) {
    const n = r[t];
    ...
    try {
      let h;
      if (n.deps) (h = n.when(l)), A.set(t, new Set(n.deps));
      else {
        const S = Re(() => n.when(l));
        (h = S.value), A.set(t, S.deps);
      }
      return h instanceof Promise
        ...
        : ((a.lastResult = h), (a.isEvaluating = !1), o?.(t, h), h);
    } catch (h) {
      return (
  ...
  async function w(t) {
    ...
    try {
      const S = n.when(l),
        M = await xe(S, h, `Constraint "${t}" timed out after ${h}ms`);
      return (a.lastResult = M), (a.isEvaluating = !1), o?.(t, M), M;
    } catch (S) {
      return (
        (a.error = S instanceof Error ? S : new Error(String(S))),
        (a.lastResult = !1),
  ...
  function I(t, n) {
    return t == null ? [] : Array.isArray(t) ? t.filter((h) => h != null) : [t];
  }
  function F(t) {
    const n = r[t];
  ...
  function H(t, n) {
    ...
    const a = c.get(t) ?? new Set();
    for (const h of n)
      a.add(h), E.has(h) || E.set(h, new Set()), E.get(h).add(t);
    c.set(t, a);
  }
  let z = null;
  function v() {
  ...
  function k(t) {
    ...
    for (const a of n.after)
      if (r[a] && !g.has(a) && !D.has(a) && !x.has(a)) return !1;
    return !0;
  }
  return {
    async evaluate(t) {
      const n = new Pe();
      D.clear();
      let a = v().filter((_) => !g.has(_)),
        h;
      if (!O || !t || t.size === 0) (h = a), (O = !0);
      else {
        const _ = new Set();
        for (const U of t) {
          const Y = E.get(U);
          if (Y) for (const re of Y) g.has(re) || _.add(re);
        }
        for (const U of T) g.has(U) || _.add(U);
        T.clear(), (h = [..._]);
        for (const U of a)
          if (!_.has(U)) {
            const Y = j.get(U);
      ...
      function S(_, U) {
        ...
        const Y = A.get(_);
        if (!U) {
          Y !== void 0 && u(_, Y), D.add(_), j.set(_, []);
          return;
        }
        D.delete(_);
        let re, ee;
        try {
          ...
          f?.(_, X), Y !== void 0 && u(_, Y), j.set(_, []);
          return;
        }
        if (Y !== void 0) {
          const X = new Set(Y);
          for (const V of ee) X.add(V);
          u(_, X);
        } else H(_, ee);
        if (re.length > 0) {
          const X = s[_],
      ...
      async function M(_) {
        ...
        const re = [],
          ee = [];
        for (const V of Y) P(V).isAsync ? ee.push(V) : re.push(V);
        const X = [];
        for (const V of re) {
          const J = b(V);
        ...
        if (X.length > 0) {
          ...
          for (const { id: J, active: G } of V) S(J, G);
        }
        if (ee.length > 0) {
          const V = await Promise.all(
      ...
      while (N.length > 0 && W > 0) {
        const _ = N.length;
        if (((N = await M(N)), N.length === _)) break;
        W--;
      }
      return n.all();
    },
    ...
    disable(t) {
      g.add(t), (z = null), j.delete(t);
      const n = c.get(t);
      if (n) {
        for (const a of n) {
          const h = E.get(a);
          h && (h.delete(t), h.size === 0 && E.delete(a));
        }
        c.delete(t);
      }
      A.delete(t);
    ...
    registerDefinitions(t) {
      for (const [n, a] of Object.entries(t)) (r[n] = a), R(n), T.add(n);
      (z = null), y(), $();
    },
  };
}
function qt(e) {
  ...
  function L(y) {
    ...
    C.isComputing = !0;
    try {
      const { value: P, deps: u } = Re(() => R(l, O));
      return (
        (C.cachedValue = P), (C.isStale = !1), q(y, u), s?.(y, P, [...u]), P
      );
    } catch (P) {
      throw (o?.(y, P), P);
    } finally {
  ...
  function q(y, C) {
    ...
    for (const u of P)
      if (f.has(u)) {
        const b = p.get(u);
        b?.delete(y), b && b.size === 0 && p.delete(u);
      } else {
        const b = g.get(u);
        b?.delete(y), b && b.size === 0 && g.delete(u);
      }
    for (const u of C)
      r[u]
        ? (p.has(u) || p.set(u, new Set()), p.get(u).add(y))
        : (g.has(u) || g.set(u, new Set()), g.get(u).add(y));
    R.dependencies = C;
  }
  function m() {
    if (!(E > 0 || A)) {
      ...
      try {
        ...
        while (T.size > 0) {
          ...
          const C = [...T];
          T.clear();
          for (const R of C) d.get(R)?.forEach((P) => P());
        }
      } finally {
        A = !1;
      }
  ...
  return (
    ...
    )),
    {
      get(y) {
        const C = D(y);
        return C.isStale && L(y), C.cachedValue;
      },
      isStale(y) {
        return f.get(y)?.isStale ?? !0;
      },
      invalidate(y) {
        const C = g.get(y);
        if (C) {
      ...
      subscribe(y, C) {
        for (const R of y) {
          const P = R;
          d.has(P) || d.set(P, new Set()), d.get(P).add(C);
        }
        return () => {
          for (const R of y) {
            const P = R,
              u = d.get(P);
            u?.delete(C), u && u.size === 0 && d.delete(P);
          }
        };
      },
      getProxy() {
      ...
      registerDefinitions(y) {
        for (const [C, R] of Object.entries(y)) (r[C] = R), x(C);
      },
    }
  );
}
function Tt(e) {
  let { definitions: r, facts: l, store: s, onRun: i, onError: o } = e,
    f = new Map(),
    d = null,
    g = !1;
  function p(x) {
    const D = r[x];
    if (!D) throw new Error(`[Directive] Unknown effect: ${x}`);
    const L = {
      id: x,
      enabled: !0,
  ...
  function T(x, D) {
    ...
    if (L.dependencies) {
      for (const q of L.dependencies) if (D.has(q)) return !0;
      return !1;
    }
    return !0;
  }
      ...
      try {
        if (D.hasExplicitDeps) {
          ...
          y instanceof Promise && (y = await y),
            j(D, y),
            (D.dependencies = q.size > 0 ? q : null);
        }
      } catch (q) {
        o?.(x, q),
          console.error(`[Directive] Effect "${x}" threw an error:`, q);
      }
    }
  }
  ...
  return {
    async runEffects(x) {
      const D = [];
      for (const L of Object.keys(r)) T(L, x) && D.push(L);
      await Promise.all(D.map(O)), (d = E());
    },
    async runAll() {
      const x = Object.keys(r);
      await Promise.all(
        x.map((D) => (c(D).enabled ? O(D) : Promise.resolve())),
      ),
        (d = E());
    },
    disable(x) {
    ...
    cleanupAll() {
      g = !0;
      for (const x of f.values()) A(x);
    },
    registerDefinitions(x) {
      for (const [D, L] of Object.entries(x)) (r[D] = L), p(D);
    },
  };
}
function Bt(e = {}) {
  const {
    ...
    o = new Map();
  function f(d) {
    const g = r * Math.pow(s, d - 1);
    return Math.min(g, i);
  }
  return {
    scheduleRetry(d, g, p, c, E) {
      if (c > l) return null;
      const T = f(c),
        A = {
          source: d,
...
function Pt(e = {}) {
  const { config: r = {}, onError: l, onRecovery: s } = e,
    i = [],
    o = 100,
    f = Bt(r.retryLater),
    d = new Map();
  ...
  function p(c, E, T) {
    ...
    return typeof A == "string" ? A : _t[c];
  }
  return {
    handleError(c, E, T, A) {
      const j = g(c, E, T, A);
      i.push(j), i.length > o && i.shift();
      try {
        l?.(j);
      } catch (x) {
      ...
      let O = p(c, E, T instanceof Error ? T : new Error(String(T)));
      if (O === "retry-later") {
        const x = (d.get(E) ?? 0) + 1;
        d.set(E, x),
          f.scheduleRetry(c, E, A, x) ||
            ((O = "skip"), d.delete(E), typeof process < "u");
      }
      try {
        s?.(j, O);
      } catch (x) {
...
function Lt() {
  ...
  return {
    ...
    emitFactSet(s, i, o) {
      for (const f of e) r(() => f.onFactSet?.(s, i, o));
    },
    emitFactDelete(s, i) {
    ...
    emitDerivationCompute(s, i, o) {
      for (const f of e) r(() => f.onDerivationCompute?.(s, i, o));
    },
    ...
    emitResolverComplete(s, i, o) {
      for (const f of e) r(() => f.onResolverComplete?.(s, i, o));
    },
    emitResolverError(s, i, o) {
      for (const f of e) r(() => f.onResolverError?.(s, i, o));
    },
    emitResolverRetry(s, i, o) {
      for (const f of e) r(() => f.onResolverRetry?.(s, i, o));
    },
...
function zt(e) {
  ...
  function L(u) {
    return (
      ...
      u !== null &&
      "requirement" in u &&
      typeof u.requirement == "function"
    );
  }
  function q(u, b) {
    return D(u) ? b.type === u.requirement : L(u) ? u.requirement(b) : !1;
  }
  function m(u) {
    const b = u.type,
      w = j.get(b);
  ...
  function $(u) {
    return { facts: l, signal: u, snapshot: () => l.$snapshot() };
  }
  async function y(u, b, w) {
    const I = r[u];
    if (!I) return;
    let F = { ...Ye, ...I.retry },
      H = null;
    for (let z = 1; z <= F.attempts; z++) {
      ...
      try {
        ...
        if (I.resolve) {
          ...
          const a = I.timeout;
          a && a > 0
            ? await xe(n, a, `Resolver "${u}" timed out after ${a}ms`)
            : await n;
        }
        ...
        if (
          ...
          return;
        if (F.shouldRetry && !F.shouldRetry(H, z)) break;
        if (z < F.attempts) {
          if (w.signal.aborted) return;
          const t = Xe(F, z);
          if (
    ...
    for (let t = 1; t <= I.attempts; t++) {
      ...
      try {
        ...
        if (w.resolveBatchWithResults) {
          ...
          if (
            ...
            k && k > 0
              ? (h = await xe(
                  S,
                  k,
                  `Batch resolver "${u}" timed out after ${k}ms`,
                ))
              : (h = await S),
            h.length !== b.length)
          )
            throw new Error(
              `[Directive] Batch resolver "${u}" returned ${h.length} results but expected ${b.length}. Results array must match input order.`,
            );
          let M = Date.now() - z,
            N = !1;
          ...
          if (!N || b.some((W, _) => h[_]?.success)) return;
        } else {
          let h;
          s.batch(() => {
            ...
            k && k > 0
              ? await xe(h, k, `Batch resolver "${u}" timed out after ${k}ms`)
              : await h;
          const S = Date.now() - z;
          for (const M of b)
            E.set(M.id, {
  ...
  function R(u, b) {
    ...
    if (!w) return;
    const I = { ...Ge, ...w.batch };
    A.has(u) || A.set(u, { resolverId: u, requirements: [], timer: null });
    const F = A.get(u);
  ...
  return {
    resolve(u) {
      ...
      const b = m(u.requirement);
      if (!b) {
        console.warn(`[Directive] No resolver found for requirement: ${u.id}`);
        return;
      }
      const w = r[b];
      if (!w) return;
      ...
      const I = new AbortController(),
        ...
        H = {
          ...
          startedAt: F,
          attempt: 1,
          status: { state: "pending", requirementId: u.id, startedAt: F },
          originalRequirement: u,
        };
      c.set(u.id, H),
        i?.(b, u),
        y(b, u, I).finally(() => {
    ...
    cancelAll() {
      for (const [u] of c) this.cancel(u);
      for (const u of A.values()) u.timer && clearTimeout(u.timer);
      A.clear();
    },
    getStatus(u) {
      const b = c.get(u);
      return b ? b.status : E.get(u) || { state: "idle" };
    },
    getInflight() {
      return [...c.keys()];
    },
    ...
    processBatches() {
      for (const u of A.keys()) P(u);
    },
    registerDefinitions(u) {
      for (const [b, w] of Object.entries(u)) r[b] = w;
      j.clear();
    },
  };
}
function Nt(e) {
  let { config: r, facts: l, store: s, onSnapshot: i, onTimeTravel: o } = e,
    f = r.timeTravel ?? !1,
  ...
  return {
    ...
    takeSnapshot(q) {
      ...
      const m = { id: c++, timestamp: Date.now(), facts: D(), trigger: q };
      for (
    ...
    goBack(q = 1) {
      ...
      let m = p,
        $ = p,
        y = A.find((R) => p > R.startIndex && p <= R.endIndex);
      if (y) $ = y.startIndex;
      else if (A.find((R) => p === R.startIndex)) {
        const R = A.find((P) => P.endIndex < p && p - P.endIndex <= q);
        $ = R ? R.startIndex : Math.max(0, p - q);
      } else $ = Math.max(0, p - q);
      if (m === $) return;
      p = $;
      const C = g[p];
      C && (this.restore(C), o?.(m, $));
    },
    goForward(q = 1) {
      if (!f || g.length === 0) return;
      let m = p,
        $ = p,
        y = A.find((R) => p >= R.startIndex && p < R.endIndex);
      if ((y ? ($ = y.endIndex) : ($ = Math.min(g.length - 1, p + q)), m === $))
        return;
      p = $;
      const C = g[p];
      C && (this.restore(C), o?.(m, $));
    ...
    endChangeset() {
      !f ||
        j === null ||
        (p > O && A.push({ label: j, startIndex: O, endIndex: p }),
        (j = null),
        (O = -1));
    },
    pause() {
...
function gt(e) {
    ...
    const n = (a, h) => {
      if (a) {
        for (const S of Object.keys(a))
          if (ae.has(S))
            throw new Error(
              `[Directive] Security: Module "${t.id}" has dangerous key "${S}" in ${h}. This could indicate a prototype pollution attempt.`,
            );
      }
    };
    n(t.schema, "schema"),
  ...
  let E = Pt({
    ...
    { store: O, facts: x } = Rt({
      ...
      onChange: (t, n, a) => {
        c.emitFactSet(t, n, a),
          T(t),
          !j?.isRestoring && (g === 0 && (p = !0), w.changedKeys.add(t), I());
      },
      onBatch: (t) => {
        c.emitFactsBatch(t);
        const n = [];
    ...
    D = qt({
      definitions: s,
      facts: x,
      onCompute: (t, n, a) => c.emitDerivationCompute(t, n, a),
      onInvalidate: (t) => c.emitDerivationInvalidate(t),
      onError: (t, n) => {
        E.handleError("derivation", t, n);
      },
    });
  (T = (t) => D.invalidate(t)), (A = (t) => D.invalidateMany(t));
  const L = Tt({
      definitions: i,
      facts: x,
      store: O,
    ...
    m = zt({
      ...
      onComplete: (t, n, a) => {
        c.emitResolverComplete(t, n, a),
          c.emitRequirementMet(n, t),
          q.markResolved(n.fromConstraint);
      },
      onError: (t, n, a) => {
        E.handleError("resolver", t, a, n), c.emitResolverError(t, n, a);
      },
      onRetry: (t, n, a) => c.emitResolverRetry(t, n, a),
      onCancel: (t, n) => {
    ...
    if (!w.isReconciling) {
      ...
      try {
        w.changedKeys.size > 0 &&
          ...
          (p = !1));
        const t = x.$snapshot();
        c.emitReconcileStart(t), await L.runEffects(w.changedKeys);
        const n = new Set(w.changedKeys);
        w.changedKeys.clear();
        const a = await q.evaluate(n),
          h = new Pe();
        for (const _ of a) h.add(_), c.emitRequirementCreated(_);
        ...
        const N = m.getInflightInfo(),
          W = {
            unmet: a.filter((_) => !m.isResolving(_.id)),
            inflight: N,
            completed: [],
            canceled: M.map((_) => ({
              id: _.id,
              resolverId: N.find((U) => U.id === _.id)?.resolverId ?? "unknown",
            })),
          };
  ...
  const H = new Proxy(
      {},
      {
        ...
        has(t, n) {
          return typeof n == "symbol" || ae.has(n) ? !1 : n in s;
        },
        ownKeys() {
          return Object.keys(s);
        },
        getOwnPropertyDescriptor(t, n) {
          if (typeof n != "symbol" && !ae.has(n) && n in s)
    ...
    v = {
      ...
      initialize() {
        if (!w.isInitialized) {
          ...
          e.onAfterModuleInit &&
            ...
            (w.isInitializing = !1),
            (w.isInitialized = !0);
          for (const t of Object.keys(s)) D.get(t);
        }
      },
      start() {
        if (!w.isRunning) {
      ...
      dispatch(t) {
        if (ae.has(t.type)) return;
        const n = l[t.type];
        if (n) {
          g++, (d === null || d.has(t.type)) && (p = !0);
          try {
            O.batch(() => {
              n(x, t);
            });
      ...
      subscribe(t, n) {
        const a = [],
          h = [];
        for (const M of t) M in s ? a.push(M) : M in r && h.push(M);
        const S = [];
        return (
          a.length > 0 && S.push(D.subscribe(a, n)),
          h.length > 0 && S.push(O.subscribe(h, n)),
          () => {
            for (const M of S) M();
          }
        );
...
`)
        ...
        for (;;) {
          ...
          if (Date.now() - n > t) {
            ...
            throw (
              ...
              new Error(
                `[Directive] settle() timed out after ${t}ms. ${h.join("; ")}`,
              ))
            );
          }
      ...
      getDistributableSnapshot(t = {}) {
        let {
          ...
          _ = Object.keys(s),
          U;
        if ((n ? (U = n.filter((ee) => _.includes(ee))) : (U = _), a)) {
          const ee = new Set(a);
      ...
      watchDistributableSnapshot(t, n) {
        let { includeDerivations: a, excludeDerivations: h } = t,
          S = Object.keys(s),
          M;
  ...
  function k(t) {
    ...
    const n = (a, h) => {
      if (a) {
        for (const S of Object.keys(a))
          if (ae.has(S))
            throw new Error(
              `[Directive] Security: Module "${t.id}" has dangerous key "${S}" in ${h}.`,
            );
      }
    };
    n(t.schema, "schema"),
    ...
    if (t.snapshotEvents) {
      ...
      for (const a of t.snapshotEvents) d.add(a);
    } else if (d !== null && t.events)
      for (const a of Object.keys(t.events)) d.add(a);
    Object.assign(r, t.schema),
      t.events && Object.assign(l, t.events),
      t.derive && (Object.assign(s, t.derive), D.registerDefinitions(t.derive)),
      t.effects &&
        (Object.assign(i, t.effects), L.registerDefinitions(t.effects)),
      t.constraints &&
        (Object.assign(o, t.constraints), q.registerDefinitions(t.constraints)),
      t.resolvers &&
        (Object.assign(f, t.resolvers), m.registerDefinitions(t.resolvers)),
...
function Wt(e) {
  ...
  function f(d) {
    ...
    if (g?.crossModuleDeps)
      for (const p of Object.keys(g.crossModuleDeps)) r.includes(p) && f(p);
    o.pop(), s.delete(d), l.add(d), i.push(d);
  }
  for (const d of r) f(d);
  return i;
}
var Qe = new WeakMap(),
  Ze = new WeakMap(),
...
function Kt(e) {
  ...
  for (const m of i) {
    const $ = r[m];
    if (!$) continue;
    const y = $.crossModuleDeps && Object.keys($.crossModuleDeps).length > 0,
      C = y ? Object.keys($.crossModuleDeps) : [],
      R = {};
    for (const [v, k] of Object.entries($.schema.facts)) R[`${m}${K}${v}`] = k;
    const P = {};
    if ($.schema.derivations)
      for (const [v, k] of Object.entries($.schema.derivations))
        P[`${m}${K}${v}`] = k;
    const u = {};
    if ($.schema.events)
      for (const [v, k] of Object.entries($.schema.events))
        u[`${m}${K}${v}`] = k;
    const b = $.init
        ? (v) => {
            const k = ie(v, m);
      ...
      w = {};
    if ($.derive)
      for (const [v, k] of Object.entries($.derive))
        w[`${m}${K}${v}`] = (t, n) => {
          const a = y ? ce(t, m, C) : ie(t, m),
            h = Le(n, m);
          return k(a, h);
        };
    const I = {};
    if ($.events)
      for (const [v, k] of Object.entries($.events))
        I[`${m}${K}${v}`] = (t, n) => {
          const a = ie(t, m);
          k(a, n);
        };
    const F = {};
    if ($.constraints)
      for (const [v, k] of Object.entries($.constraints)) {
        const t = k;
        F[`${m}${K}${v}`] = {
          ...t,
          deps: t.deps?.map((n) => `${m}${K}${n}`),
          when: (n) => {
            const a = y ? ce(n, m, C) : ie(n, m);
            return t.when(a);
          },
          require:
    ...
    const H = {};
    if ($.resolvers)
      for (const [v, k] of Object.entries($.resolvers)) {
        const t = k;
        H[`${m}${K}${v}`] = {
          ...t,
          resolve: async (n, a) => {
            const h = Ae(a.facts, r, () => Object.keys(r));
            await t.resolve(n, { facts: h[m], signal: a.signal });
          },
        };
      }
    const z = {};
    if ($.effects)
      for (const [v, k] of Object.entries($.effects)) {
        const t = k;
        z[`${m}${K}${v}`] = {
          ...t,
          run: (n, a) => {
            const h = y ? ce(n, m, C) : ie(n, m),
              S = a ? (y ? ce(a, m, C) : ie(a, m)) : void 0;
            return t.run(h, S);
          },
          deps: t.deps?.map((n) => `${m}${K}${n}`),
        };
    ...
    g.push({
      ...
      hooks: $.hooks,
      snapshotEvents:
        s && !s.has(m) ? [] : $.snapshotEvents?.map((v) => `${m}${K}${v}`),
    });
  }
  let p = null,
    c = null;
  function E(m) {
    for (const [$, y] of Object.entries(m))
      if (!ne.has($) && l.has($)) {
        ...
        for (const [C, R] of Object.entries(y))
          ne.has(C) || (c.facts[`${$}${K}${C}`] = R);
      }
  }
  c = gt({
    modules: g.map((m) => ({
  ...
  for (const m of Object.keys(r)) {
    ...
    if (!$) continue;
    const y = [];
    for (const C of Object.keys($.schema.facts)) y.push(`${m}${K}${C}`);
    if ($.schema.derivations)
      for (const C of Object.keys($.schema.derivations)) y.push(`${m}${K}${C}`);
    T.set(m, y);
  }
  const A = { names: null };
  function j() {
  ...
  return {
    ...
    start() {
      if ((c.start(), q && q > 0)) {
        const m = Object.keys(g[0]?.events ?? {}).find(($) =>
          $.endsWith(`${K}tick`),
        );
        m &&
          (L = setInterval(() => {
    ...
    subscribeModule(m, $) {
      const y = T.get(m);
      return !y || y.length === 0 ? () => {} : c.subscribe(y, $);
    },
    watch(m, $, y) {
      return c.watch(ue(m), $, y);
    },
    when(m, $) {
      return c.when(() => m(O), $);
    },
    ...
    getDistributableSnapshot(m) {
      const $ = {
        ...
        y = c.getDistributableSnapshot($),
        C = {};
      for (const [R, P] of Object.entries(y.data)) {
        const u = R.indexOf(K);
        if (u > 0) {
          const b = R.slice(0, u),
            w = R.slice(u + K.length);
          C[b] || (C[b] = {}), (C[b][w] = P);
        } else C._root || (C._root = {}), (C._root[R] = P);
      }
      return { ...y, data: C };
    },
    watchDistributableSnapshot(m, $) {
      ...
      return c.watchDistributableSnapshot(y, (C) => {
        const R = {};
        for (const [P, u] of Object.entries(C.data)) {
          const b = P.indexOf(K);
          if (b > 0) {
            const w = P.slice(0, b),
              I = P.slice(b + K.length);
            R[w] || (R[w] = {}), (R[w][I] = u);
          } else R._root || (R._root = {}), (R._root[P] = u);
        }
        $({ ...C, data: R });
      });
    },
    registerModule(m, $) {
      ...
      const y = $,
        ...
        R = C ? Object.keys(y.crossModuleDeps) : [],
        P = {};
      ...
      if (y.effects)
        for (const [v, k] of Object.entries(y.effects)) {
          ...
          H[`${m}${K}${v}`] = {
            ...t,
            run: (n, a) => {
              const h = C ? ce(n, m, R) : ie(n, m),
                S = a ? (C ? ce(a, m, R) : ie(a, m)) : void 0;
              return t.run(h, S);
            },
            deps: t.deps?.map((n) => `${m}${K}${n}`),
          };
        }
      l.add(m), (r[m] = y), (A.names = null);
      const z = [];
      for (const v of Object.keys(y.schema.facts)) z.push(`${m}${K}${v}`);
      ...
      T.set(m, z),
        c.registerModule({
          ...
          hooks: y.hooks,
          snapshotEvents:
            s && !s.has(m) ? [] : y.snapshotEvents?.map((v) => `${m}${K}${v}`),
        });
    },
  };
}
    ...
    {},
    {
      get(i, o) {
        if (typeof o != "symbol" && !ne.has(o))
          return o === "$store" || o === "$snapshot" ? e[o] : e[`${r}${K}${o}`];
      },
      set(i, o, f) {
      ...
      has(i, o) {
        return typeof o == "symbol" || ne.has(o) ? !1 : `${r}${K}${o}` in e;
      },
      deleteProperty(i, o) {
        return typeof o == "symbol" || ne.has(o)
          ? !1
...
function Ae(e, r, l) {
  ...
  const i = new Proxy(
    ...
    {
      get(o, f) {
        if (typeof f != "symbol" && !ne.has(f) && Object.hasOwn(r, f))
          return ie(e, f);
      },
      has(o, f) {
        return typeof f == "symbol" || ne.has(f) ? !1 : Object.hasOwn(r, f);
      },
      ownKeys() {
        return l();
      },
      getOwnPropertyDescriptor(o, f) {
        if (typeof f != "symbol" && Object.hasOwn(r, f))
          return { configurable: !0, enumerable: !0 };
      },
    },
  );
...
function Le(e, r) {
  ...
  if (l) {
    const i = l.get(r);
    if (i) return i;
  } else (l = new Map()), tt.set(e, l);
  const s = new Proxy(
    {},
    {
      get(i, o) {
        if (typeof o != "symbol" && !ne.has(o)) return e[`${r}${K}${o}`];
      },
      has(i, o) {
        return typeof o == "symbol" || ne.has(o) ? !1 : `${r}${K}${o}` in e;
      },
...
function Jt(e) {
  ...
  if (e.tickMs !== void 0 && e.tickMs <= 0)
    throw new Error("[Directive] tickMs must be a positive number");
  if (e.initialFacts && !$e(e.initialFacts))
    throw new Error(
    ...
    onAfterModuleInit: () => {
      if (e.initialFacts)
        for (const [p, c] of Object.entries(e.initialFacts))
          ne.has(p) || (o.facts[p] = c);
      if (i) {
        for (const [p, c] of Object.entries(i)) ne.has(p) || (o.facts[p] = c);
        i = null;
      }
    },
  });
...
function or(e, r, l, s) {
  ...
  (f.textContent = `[data-directive-devtools] summary:focus-visible{outline:2px solid ${B.accent};outline-offset:2px;border-radius:2px}[data-directive-devtools] button:focus-visible{outline:2px solid ${B.accent};outline-offset:2px}`),
  ...
  function L(V, J) {
    ...
    He.appendChild(Ke), de.appendChild(He);
    const Ve = document.createElement("tbody");
    return (
      de.appendChild(Ve),
      G.appendChild(de),
      { details: G, tbody: Ve, countSpan: pe }
    );
  }
  function q(V, J) {
    const G = document.createElement("details");
    ...
    return (
      ...
      G.appendChild(de),
      { details: G, list: de, countSpan: pe }
    );
  }
  const m = L("Facts", !0);
  g.appendChild(m.details);
  const $ = L("Derivations", !1);
  g.appendChild($.details);
  const y = q("Inflight", B.yellow);
  g.appendChild(y.details);
  ...
  Object.assign(P.style, {
    ...
    (P.textContent = "Performance"),
    R.appendChild(P);
  const u = document.createElement("div");
  (u.style.fontSize = "10px"),
    (u.style.color = B.muted),
    (u.textContent = "No data yet"),
    R.appendChild(u),
    g.appendChild(R);
    ...
    g.addEventListener(
      ...
      (V) => {
        const J = g,
          ...
          le = J.scrollTop + J.clientHeight >= J.scrollHeight && V.deltaY > 0;
        (G || le) && V.preventDefault();
      },
      { passive: !1 },
    );
  let N = l,
  ...
  d.addEventListener("click", _), E.addEventListener("click", U);
  function Y(V) {
    V.key === "Escape" && N && U();
  }
  ...
  function X() {
    ...
    W.clear(), d.remove(), g.remove(), f.remove();
  }
  return {
    refs: {
      container: g,
...
function ke(e, r, l, s, i, o) {
  let f = vt(s),
    d = e.get(l);
  if (d) {
    const g = d.cells;
    if (g[1] && ((g[1].textContent = f), i && o)) {
      const p = g[1];
...
function lt(e, r, l, s) {
  ...
  const o = new Set(i);
  for (const [f, d] of r) o.has(f) || (d.remove(), r.delete(f));
  for (const f of i) {
    let d;
    try {
      d = vt(l.read(f));
...
function lr(e, r, l, s) {
  ...
  let f = new Date(),
    d = `${String(f.getHours()).padStart(2, "0")}:${String(f.getMinutes()).padStart(2, "0")}:${String(f.getSeconds()).padStart(2, "0")}.${String(f.getMilliseconds()).padStart(3, "0")}`,
    g;
  try {
...
function ar(e, r) {
  ...
  const l =
      r.reconcileCount > 0
        ...
        : "—",
    s = [
      `Reconciles: ${r.reconcileCount}  (avg ${l}ms)`,
  ...
  if (r.resolverStats.size > 0) {
    ...
    const o = [...r.resolverStats.entries()].sort(
      (f, d) => d[1].totalMs - f[1].totalMs,
    );
    for (const [f, d] of o) {
      const g = d.count > 0 ? (d.totalMs / d.count).toFixed(1) : "0",
        p = document.createElement("div");
      (p.style.paddingLeft = "8px"),
        (p.textContent = `${f}: ${d.count}x, avg ${g}ms${d.errors > 0 ? `, ${d.errors} err` : ""}`),
...
var Ie = new WeakMap();
function ur(e, r, l, s, i, o) {
  return [
    e.join(","),
    r.join(","),
    l.map((f) => `${f.id}:${f.active}`).join(","),
    [...s.entries()].map(([f, d]) => `${f}:${d.status}:${d.type}`).join(","),
    i.join(","),
    o.join(","),
  ].join("|");
}
function dr(e, r, l, s, i) {
  for (const o of l) {
    const f = e.nodes.get(`0:${o}`);
    if (!f) continue;
    const d = r.recentlyChangedFacts.has(o);
    f.rect.setAttribute("fill", d ? B.text + "33" : "none"),
      f.rect.setAttribute("stroke-width", d ? "2" : "1");
  }
  for (const o of s) {
    const f = e.nodes.get(`1:${o}`);
    if (!f) continue;
    const d = r.recentlyComputedDerivations.has(o);
    f.rect.setAttribute("fill", d ? B.accent + "33" : "none"),
      f.rect.setAttribute("stroke-width", d ? "2" : "1");
  }
  for (const o of i) {
    const f = e.nodes.get(`2:${o}`);
    if (!f) continue;
    const d = r.recentlyActiveConstraints.has(o),
      g = f.rect.getAttribute("stroke") ?? B.muted;
    f.rect.setAttribute("fill", d ? g + "33" : "none"),
      f.rect.setAttribute("stroke-width", d ? "2" : "1");
  }
}
function ct(e, r, l) {
  ...
  const E = g.map((v) => v.resolverId).sort(),
    T = ur(i, o, f, c, p, E),
    A = Ie.get(e.flowSvg);
  ...
  const L = D(i.map((v) => ({ id: v, label: me(v, Z.labelMaxChars) }))),
    q = D(o.map((v) => ({ id: v, label: me(v, Z.labelMaxChars) }))),
    m = D(
      f.map((v) => ({
        id: v.id,
        label: me(v.id, Z.labelMaxChars),
        active: v.active,
        priority: v.priority,
      })),
    ),
    ...
    y = D(p.map((v) => ({ id: v, label: me(v, Z.labelMaxChars) }))),
    C = Math.max(L.length, q.length, m.length, $.length, y.length, 1),
    R = Z.startY + 12 + C * (Z.nodeH + Z.nodeGap) + 8;
  e.flowSvg.replaceChildren(),
    e.flowSvg.setAttribute("viewBox", `0 0 ${x} ${R}`),
    e.flowSvg.setAttribute(
      "aria-label",
      `Dependency graph: ${i.length} facts, ${o.length} derivations, ${f.length} constraints, ${c.size} requirements, ${p.length} resolvers`,
    );
  const P = ["Facts", "Derivations", "Constraints", "Reqs", "Resolvers"];
  for (const [v, k] of P.entries()) {
    const t = document.createElementNS("http://www.w3.org/2000/svg", "text");
    t.setAttribute("x", String(O[v] ?? 0)),
      t.setAttribute("y", "10"),
      t.setAttribute("fill", B.accent),
      t.setAttribute("font-size", String(Z.fontSize)),
      t.setAttribute("font-family", B.font),
      (t.textContent = k),
      e.flowSvg.appendChild(t);
  }
  const u = { fingerprint: T, nodes: new Map() };
  function b(v, k, t, n, a, h, S, M) {
    ...
    return (
      ...
      _.setAttribute("fill", h),
      _.setAttribute("font-size", String(Z.fontSize)),
      _.setAttribute("font-family", B.font),
      _.setAttribute("opacity", S ? "0.35" : "1"),
      (_.textContent = a),
      N.appendChild(_),
      e.flowSvg.appendChild(N),
      u.nodes.set(`${v}:${n}`, { g: N, rect: W, text: _ }),
      { midX: k + Z.nodeW / 2, midY: t }
    );
  }
  function w(v, k, t, n, a, h) {
  ...
  for (const v of L) {
    const k = l.recentlyChangedFacts.has(v.id),
      t = b(0, O[0], v.y, v.id, v.label, B.text, !1, k);
    I.set(v.id, t);
  }
  for (const v of q) {
    const k = l.recentlyComputedDerivations.has(v.id),
      t = b(1, O[1], v.y, v.id, v.label, B.accent, !1, k);
    F.set(v.id, t);
  }
  for (const v of m) {
  ...
  for (const v of $) {
    const k = v.status === "unmet" ? B.red : B.yellow,
      t = b(3, O[3], v.y, v.id, me(v.type, Z.labelMaxChars), k, !1, !1);
    z.set(v.id, t);
  }
  for (const v of y) {
    const k = g.some((t) => t.resolverId === v.id);
    b(4, O[4], v.y, v.id, v.label, k ? B.green : B.muted, !k, !1);
  }
  for (const v of q) {
  ...
  for (const v of $) {
    const k = H.get(v.fromConstraint),
      t = z.get(v.id);
    k &&
      t &&
      w(k.midX + Z.nodeW / 2, k.midY, t.midX - Z.nodeW / 2, t.midY, B.muted);
  }
  for (const v of g) {
    const k = z.get(v.id);
    if (k) {
      const t = y.find((n) => n.id === v.resolverId);
      t && w(k.midX + Z.nodeW / 2, k.midY, O[4], t.y, B.green);
    }
  }
  Ie.set(e.flowSvg, u);
}
...
function pr(e, r) {
  const l = r.entries.toArray();
  if (l.length === 0) return;
  e.timelineSvg.replaceChildren();
  let s = 1 / 0,
    i = -1 / 0;
  for (const A of l)
    A.startMs < s && (s = A.startMs), A.endMs > i && (i = A.endMs);
  const o = performance.now();
  for (const A of r.inflight.values()) A < s && (s = A), o > i && (i = o);
  const f = i - s || 1,
    d = De - we - 10,
    g = [],
    p = new Set();
  for (const A of l)
    p.has(A.resolver) || (p.add(A.resolver), g.push(A.resolver));
  for (const A of r.inflight.keys()) p.has(A) || (p.add(A), g.push(A));
  const c = g.slice(-12),
    E = be * c.length + 20;
  e.timelineSvg.setAttribute("viewBox", `0 0 ${De} ${E}`),
  ...
  for (let A = 0; A <= T; A++) {
    ...
    D.setAttribute("x1", String(j)),
      ...
      D.setAttribute("y2", String(E)),
      D.setAttribute("stroke", B.border),
  ...
  for (let A = 0; A < c.length; A++) {
    ...
    if (m !== void 0) {
      ...
      C.setAttribute("x", String($)),
        ...
        C.setAttribute("height", String(be - 4)),
        C.setAttribute("rx", "2"),
      ...
      (R.textContent = `${j}: inflight ${(o - m).toFixed(0)}ms`),
        C.appendChild(R),
        ...
        subscribe(l, s) {
          ...
          if (!i) {
            let o = !1,
              ...
              d = setTimeout(() => clearInterval(f), 1e4);
            return () => {
              clearInterval(f), clearTimeout(d);
...
function hr(e = {}) {
  ...
  let c = (n, a) => {
    ...
    x = nr(),
    D = Zt(),
    L = i && typeof window < "u" && typeof document < "u" && Ne(),
    q = null,
    m = 0,
    $ = 1,
    y = 2,
  ...
  function v() {
    ...
    const n = E.refs,
      ...
      h = m;
    if (((m = 0), h & $)) {
      for (const S of F) sr(T, S);
      F.clear();
      for (const [S, { value: M, flash: N }] of I)
        ke(T, n.factsBody, S, M, N, E.flashTimers);
      I.clear(), (n.factsCount.textContent = String(T.size));
    }
    if ((h & y && lt(n, A, a, E.flashTimers), h & R))
    ...
    if (h & C)
      if (H) je(n, H.inflight, H.unmet);
      else {
        const S = Ce(a);
        S && je(n, S.inflight, S.unmet);
      }
    h & P && ar(n, j),
      h & u && ct(n, a, O),
      h & b && at(n, a),
  ...
  function k(n, a) {
    E && l && lr(E.refs, n, a, p.events.size);
  }
  function t(n, a) {
    x.isRecording &&
      x.recordedEvents.length < tr &&
      x.recordedEvents.push({ timestamp: Date.now(), type: n, data: Yt(a) });
  }
  return {
    name: "devtools",
    onInit: (n) => {
      if (
        ...
        try {
          ...
          for (const [N, W] of Object.entries(M)) ke(T, h.factsBody, N, W, !1);
        ...
        S &&
          ...
          h.recordBtn.addEventListener("click", () => {
            if (
              ...
              (h.recordBtn.textContent = x.isRecording ? "⏹ Stop" : "⏺ Record"),
              (h.recordBtn.style.color = x.isRecording ? B.red : B.text),
              x.isRecording)
            ) {
    ...
    onFactSet: (n, a, h) => {
      c("fact.set", { key: n, value: a, prev: h }),
        t("fact.set", { key: n, value: a, prev: h }),
        O.recentlyChangedFacts.add(n),
        E &&
          p.system &&
    ...
    onFactDelete: (n, a) => {
      c("fact.delete", { key: n, prev: a }),
        ...
        E && (F.add(n), I.delete(n), z($), k("fact.delete", { key: n }));
    },
    onFactsBatch: (n) => {
      if (
        ...
        for (const a of n)
          a.type === "delete"
            ? (F.add(a.key), I.delete(a.key))
            : (O.recentlyChangedFacts.add(a.key),
              I.set(a.key, { value: a.value, flash: !0 }),
              F.delete(a.key));
        z($), k("facts.batch", { count: n.length });
      }
    },
    onDerivationCompute: (n, a, h) => {
      c("derivation.compute", { id: n, value: a, deps: h }),
        t("derivation.compute", { id: n, deps: h }),
        O.derivationDeps.set(n, h),
        O.recentlyComputedDerivations.add(n),
    ...
    onReconcileEnd: (n) => {
      ...
      if (x.isRecording && p.system && x.snapshots.length < rr)
        try {
          x.snapshots.push({
            timestamp: Date.now(),
    ...
    onConstraintEvaluate: (n, a) => {
      c("constraint.evaluate", { id: n, active: a }),
        ...
        a
          ? (O.activeConstraints.add(n), O.recentlyActiveConstraints.add(n))
          : O.activeConstraints.delete(n),
    ...
    onResolverComplete: (n, a, h) => {
      ...
      if (
        ...
        j.resolverStats.size > st)
      ) {
        const N = j.resolverStats.keys().next().value;
        N !== void 0 && j.resolverStats.delete(N);
      }
    ...
    onResolverError: (n, a, h) => {
      ...
      const S = j.resolverStats.get(n) ?? { count: 0, totalMs: 0, errors: 0 };
      if ((S.errors++, j.resolverStats.set(n, S), j.resolverStats.size > st)) {
        const N = j.resolverStats.keys().next().value;
        N !== void 0 && j.resolverStats.delete(N);
      }
      const M = D.inflight.get(n);
    ...
    onResolverRetry: (n, a, h) => {
      c("resolver.retry", { resolver: n, requirementId: a.id, attempt: h }),
        t("resolver.retry", { resolver: n, requirementId: a.id, attempt: h }),
...
var ut = class extends Error {
  ...
  retryAfterMs;
  state;
  constructor(e, r, l = "OPEN", s) {
    const i = s
      ? `[Directive CircuitBreaker] Circuit "${e}" is ${l}. ${s}`
      : `[Directive CircuitBreaker] Circuit "${e}" is ${l}. Request rejected. Try again in ${Math.ceil(r / 1e3)}s.`;
    super(i),
...
function qe(e = {}) {
  const {
    ...
    halfOpenMaxRequests: s = 3,
    failureWindowMs: i = 6e4,
    observability: o,
    metricPrefix: f = "circuit_breaker",
    name: d = "default",
    isFailure: g = () => !0,
    onStateChange: p,
  } = e;
  if (r < 1 || !Number.isFinite(r))
    throw new Error(
      `[Directive CircuitBreaker] failureThreshold must be >= 1, got ${r}`,
    );
  ...
  if (s < 1 || !Number.isFinite(s))
    throw new Error(
      `[Directive CircuitBreaker] halfOpenMaxRequests must be >= 1, got ${s}`,
    );
  if (i <= 0 || !Number.isFinite(i))
    throw new Error(
      `[Directive CircuitBreaker] failureWindowMs must be > 0, got ${i}`,
    );
  let c = "CLOSED",
    E = [],
    T = 0,
  ...
  function y(u) {
    ...
    (c = u),
      ...
      u === "HALF_OPEN" && ((T = 0), (A = 0)),
      p?.(b, u),
      o && o.incrementCounter(`${f}.state_change`, { name: d, from: b, to: u });
  }
  function C() {
    const u = Date.now() - i;
    return (E = E.filter((b) => b > u)), E.length;
  }
  function R() {
    L++,
      ($ = Date.now()),
      o && o.incrementCounter(`${f}.success`, { name: d }),
      c === "HALF_OPEN" && (A++, A >= s && (y("CLOSED"), (E = [])));
  }
  function P(u) {
    if (!g(u)) {
      R();
    ...
    D++, (m = Date.now()), E.push(Date.now());
    const b = r * 2;
    if (
      (E.length > b && (E = E.slice(-b)),
      o && o.incrementCounter(`${f}.failure`, { name: d }),
      c === "HALF_OPEN")
    ) {
      y("OPEN");
      return;
  ...
  return {
    async execute(u) {
      if (
        (x++,
        o && o.incrementCounter(`${f}.requests`, { name: d }),
        c === "OPEN")
      )
        if (Date.now() - O >= l) y("HALF_OPEN");
        else
          throw (
            (q++,
            o && o.incrementCounter(`${f}.rejected`, { name: d }),
            new ut(d, l - (Date.now() - O)))
          );
      if (c === "HALF_OPEN") {
        if (T >= s)
          throw (
            (q++,
            new ut(d, l, "HALF_OPEN", `Max trial requests (${s}) reached.`))
          );
        T++;
      }
      const b = Date.now();
      try {
        ...
        return (
          R(),
          o && o.observeHistogram(`${f}.latency`, Date.now() - b, { name: d }),
          w
        );
      } catch (w) {
        const I = w instanceof Error ? w : new Error(String(w));
        throw (
          (P(I),
          o && o.observeHistogram(`${f}.latency`, Date.now() - b, { name: d }),
          w)
    ...
    getState() {
      return c === "OPEN" && Date.now() - O >= l && y("HALF_OPEN"), c;
    },
    getStats() {
      return {
        state: this.getState(),
    ...
    isAllowed() {
      return c === "CLOSED" ? !0 : c === "OPEN" ? Date.now() - O >= l : T < s;
    },
  };
}
const Fe = {
  ...
  he = { openai: !1, anthropic: !1, ollama: !1 },
  se = {
    openai: qe({
      name: "openai",
      failureThreshold: 3,
      ...
      onStateChange: (e, r) => fe("circuit", `openai: ${e} → ${r}`, "circuit"),
    }),
    anthropic: qe({
      name: "anthropic",
      failureThreshold: 3,
      ...
      halfOpenMaxRequests: 2,
      onStateChange: (e, r) =>
        fe("circuit", `anthropic: ${e} → ${r}`, "circuit"),
    }),
    ollama: qe({
      name: "ollama",
      failureThreshold: 3,
      recoveryTimeMs: 5e3,
      halfOpenMaxRequests: 2,
      onStateChange: (e, r) => fe("circuit", `ollama: ${e} → ${r}`, "circuit"),
    }),
  },
  ve = [];
function fe(e, r, l) {
  ve.unshift({ time: Date.now(), event: e, detail: r, type: l }),
    ve.length > 50 && (ve.length = 50);
}
const ze = {
  facts: {
    openaiStats: oe.object(),
    anthropicStats: oe.object(),
    ollamaStats: oe.object(),
    budgetRemaining: oe.number(),
    budgetTotal: oe.number(),
    preferCheapest: oe.boolean(),
    lastProvider: oe.string(),
    totalRequests: oe.number(),
    lastError: oe.string(),
  },
  derivations: {
    openaiCircuit: oe.string(),
    anthropicCircuit: oe.string(),
    ollamaCircuit: oe.string(),
    cheapestAvailable: oe.string(),
    allDown: oe.boolean(),
  },
  events: {
    toggleProviderError: { provider: oe.string() },
    setBudget: { value: oe.number() },
...
const gr = Ot("router", {
    schema: ze,
    init: (e) => {
      (e.openaiStats = ye("OpenAI")),
        (e.anthropicStats = ye("Anthropic")),
        (e.ollamaStats = ye("Ollama")),
        (e.budgetRemaining = 1),
        (e.budgetTotal = 1),
        (e.preferCheapest = !1),
        (e.lastProvider = ""),
    ...
    derive: {
      openaiCircuit: () => se.openai.getState(),
      anthropicCircuit: () => se.anthropic.getState(),
      ollamaCircuit: () => se.ollama.getState(),
      cheapestAvailable: () => {
        const e = [];
        for (const [r, l] of Object.entries(Fe))
          se[r].isAllowed() && e.push({ name: r, cost: l.costPer1k });
        return (
          e.sort((r, l) => r.cost - l.cost), e.length > 0 ? e[0].name : "none"
        );
      },
      allDown: () =>
        !se.openai.isAllowed() &&
        !se.anthropic.isAllowed() &&
        !se.ollama.isAllowed(),
    },
    events: {
      toggleProviderError: (e, { provider: r }) => {
        he[r] = !he[r];
      },
      setBudget: (e, { value: r }) => {
        (e.budgetRemaining = r), (e.budgetTotal = r);
      },
      togglePreferCheapest: (e) => {
        e.preferCheapest = !e.preferCheapest;
      },
      resetStats: (e) => {
        (e.openaiStats = ye("OpenAI")),
          (e.anthropicStats = ye("Anthropic")),
          (e.ollamaStats = ye("Ollama")),
          (e.budgetRemaining = e.budgetTotal),
          (e.lastProvider = ""),
          (e.totalRequests = 0),
          (e.lastError = ""),
          (he.openai = !1),
  ...
  Q = Ht({ module: gr, plugins: [hr({ name: "provider-routing" })] });
Q.start();
function dt() {
  const e = Q.facts.budgetRemaining,
    r = Q.facts.preferCheapest,
    l = [];
  for (const [i, o] of Object.entries(Fe))
    se[i].isAllowed() &&
      e >= o.costPer1k &&
      l.push({ id: i, cost: o.costPer1k });
  if (l.length === 0) return null;
  if (r) return l.sort((i, o) => i.cost - o.cost), l[0].id;
  const s = ["openai", "anthropic", "ollama"];
  for (const i of s) if (l.find((o) => o.id === i)) return i;
  return l[0].id;
}
async function ft(e) {
  const r = se[e],
  ...
  try {
    await r.execute(async () => {
      if (
        (await new Promise((d) =>
          setTimeout(d, l.baseLatency + Math.random() * 100),
        ),
        he[e])
      )
        throw new Error(`${l.name}: simulated error`);
    });
    const i = Q.facts[s],
      o = l.costPer1k,
      f = l.baseLatency + Math.random() * 100;
    return (
      (Q.facts[s] = {
        ...i,
        callCount: i.callCount + 1,
        totalCost: Math.round((i.totalCost + o) * 1e3) / 1e3,
        avgLatencyMs: Math.round(
          (i.avgLatencyMs * i.callCount + f) / (i.callCount + 1),
        ),
        circuitState: r.getState(),
      }),
      (Q.facts.budgetRemaining =
        Math.round((Q.facts.budgetRemaining - o) * 1e3) / 1e3),
      (Q.facts.lastError = ""),
      fe("success", `${l.name}: ok ($${o})`, "success"),
      !0
    );
  } catch (i) {
    const o = Q.facts[s];
    return (
      (Q.facts[s] = {
        ...o,
        errorCount: o.errorCount + 1,
        circuitState: r.getState(),
      }),
      (Q.facts.lastError = i instanceof Error ? i.message : String(i)),
      fe("error", `${l.name}: ${Q.facts.lastError}`, "error"),
      !1
    );
  }
}
async function bt() {
  Q.facts.totalRequests = Q.facts.totalRequests + 1;
  const e = dt();
  if (!e) {
    (Q.facts.lastError = "All providers unavailable or over budget"),
      fe("error", "no available providers", "error");
    return;
  }
  if (((Q.facts.lastProvider = e), fe("route", `→ ${e}`, "route"), await ft(e)))
    return;
  const l = dt();
  l &&
    l !== e &&
    (fe("fallback", `falling back to ${l}`, "fallback"),
    (Q.facts.lastProvider = l),
    await ft(l));
}
const yr = document.getElementById("pr-insp-openai"),
  vr = document.getElementById("pr-insp-anthropic"),
  br = document.getElementById("pr-insp-ollama"),
  Te = document.getElementById("pr-timeline");
function pt(e) {
  const r = document.createElement("div");
  return (r.textContent = e), r.innerHTML;
}
function wr(e) {
  return `<span class="pr-circuit-badge ${e === "CLOSED" ? "closed" : e === "OPEN" ? "open" : "half-open"}">${e}</span>`;
}
function Be(e, r, l) {
  e.innerHTML = `
    ${wr(l)}
    <span style="font-size:0.55rem;color:var(--brand-text-dim)">${r.callCount} calls, ${r.errorCount} err, $${r.totalCost}</span>
  `;
}
function We() {
  Be(yr, Q.facts.openaiStats, se.openai.getState()),
    Be(vr, Q.facts.anthropicStats, se.anthropic.getState()),
    Be(br, Q.facts.ollamaStats, se.ollama.getState());
  for (const e of ["openai", "anthropic", "ollama"]) {
    const r = document.getElementById(`pr-err-${e}`);
    r && (r.checked = he[e] ?? !1);
  }
  if (ve.length === 0)
    Te.innerHTML =
    ...
    for (const e of ve) {
      const r = document.createElement("div");
      r.className = `pr-timeline-entry ${e.type}`;
      const s = new Date(e.time).toLocaleTimeString([], {
        hour: "2-digit",
        minute: "2-digit",
        second: "2-digit",
      });
      (r.innerHTML = `
        <span class="pr-timeline-time">${s}</span>
        <span class="pr-timeline-event">${pt(e.event)}</span>
        <span class="pr-timeline-detail">${pt(e.detail)}</span>
      `),
        Te.appendChild(r);
    }
  }
}
const Sr = [...Object.keys(ze.facts), ...Object.keys(ze.derivations)];
Q.subscribe(Sr, We);
setInterval(We, 1e3);
document.getElementById("pr-send").addEventListener("click", () => bt());
document.getElementById("pr-burst-10").addEventListener("click", async () => {
  for (let e = 0; e < 10; e++) await bt();
});
for (const e of ["openai", "anthropic", "ollama"])
  document.getElementById(`pr-err-${e}`).addEventListener("change", () => {
    Q.events.toggleProviderError({ provider: e });
  });
document.getElementById("pr-budget").addEventListener("input", (e) => {
  const r = Number(e.target.value);
  (document.getElementById("pr-budget-val").textContent = `$${r}`),
    Q.events.setBudget({ value: r });
});
document.getElementById("pr-prefer-cheapest").addEventListener("change", () => {
  Q.events.togglePreferCheapest();
});
