...
|-------|-------------------|
| [Global UI State](/docs/guides/global-ui-state) | Theme, locale, sidebar preferences with persistence and system detection |
...
| [Pagination & Infinite Scroll](/docs/guides/pagination) | Cursor-based loading with filter-aware resets and IntersectionObserver |
| [Sync State with URL](/docs/guides/url-sync) | Bidirectional URL-state sync for shareable, bookmarkable filtered views |
| [Optimistic Updates](/docs/guides/optimistic-updates) | Instant UI updates with automatic rollback on server failure |
| [Notifications & Toasts](/docs/guides/notifications) | Notification queue with auto-dismiss, priority ordering, and cross-module triggers |
| [Persist State](/docs/guides/persist-state) | Save and restore state across page reloads with selective filtering |
...
| [Organize Modules](/docs/guides/organize-modules) | Module structure, naming, and cross-module dependencies for growing apps |
...
| [Dynamic Modules](/docs/guides/dynamic-modules) | Code-split features with lazy loading and runtime module registration |
...
| Guide | What You'll Build |
|-------|-------------------|
| [Optimize Re-Renders](/docs/guides/optimize-rerenders) | Pick the right hook and derivation pattern to minimize React re-renders |
| [Batch Mutations](/docs/guides/batch-mutations) | Multi-field updates that never expose intermediate states |
| [WebSocket Connections](/docs/guides/websockets) | Managed WebSocket lifecycle with reconnection and message dispatch |
...
Complete code examples with step-by-step explanation.

| Guide | What You'll Build |
|-------|-------------------|
| [Data Fetching](/docs/guides/data-fetching) | Automatic data fetching with constraints, loading states, and error handling |
| [Form Validation](/docs/guides/form-validation) | Multi-field form validation with constraints and async validation |
| [Server-Side Usage](/docs/guides/server-side) | Express API with distributable snapshots, signed verification, and audit trails |
