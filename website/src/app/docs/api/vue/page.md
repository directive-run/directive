...
Watch a derivation or fact and execute a callback when it changes. Does not cause re-renders – use for side effects only.
...
useWatch('fact', 'userId', (newId, prevId) => {
