...
- [Debug Timeline](/docs/ai/debug-timeline) &ndash; Event types the plugin instruments
- [Evals](/docs/ai/evals) &ndash; Quality measurement
- [DevTools](/docs/ai/devtools) &ndash; Visual debugging
