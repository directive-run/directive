...
Multi-agent orchestration builds on the [Agent Orchestrator](/docs/ai/orchestrator) adapter. Define your agents, a runner, and register them:
...
| `patterns` | `Record<string, ExecutionPattern>` | `{}` | Named [execution patterns](/docs/ai/patterns) |
...
| `memory` | `AgentMemory` | &ndash; | Shared [memory](/docs/ai/memory) across all agents |
...
| `derive` | `Record<string, CrossAgentDerivationFn>` | &ndash; | [Cross-agent derivations](/docs/ai/cross-agent-state) |
| `scratchpad` | `{ init: Record<string, unknown> }` | &ndash; | [Shared scratchpad](/docs/ai/cross-agent-state#shared-scratchpad) |
| `breakpoints` | `BreakpointConfig[]` | `[]` | [Breakpoints](/docs/ai/breakpoints) |
| `onBreakpoint` | `(request) => void` | &ndash; | Breakpoint callback |
| `breakpointTimeoutMs` | `number` | `300000` | Breakpoint auto-cancel timeout |
| `onHandoff` | `(request) => void` | &ndash; | [Handoff](/docs/ai/communication#handoffs) start callback |
...
See [Guardrails](/docs/ai/guardrails) for the full API.
...
See [Streaming](/docs/ai/streaming) for chunk types and stream operators.
...
See [Execution Patterns](/docs/ai/patterns) for pattern-specific error handling (parallel `minSuccess`, sequential `continueOnError`, supervisor worker validation).
...
- [Execution Patterns](/docs/ai/patterns) &ndash; Parallel, sequential, supervisor, DAG, race, reflect, debate
- [Communication](/docs/ai/communication) &ndash; Message bus, agent network, handoffs
- [Cross-Agent State](/docs/ai/cross-agent-state) &ndash; Derivations and scratchpad
- [Self-Healing](/docs/ai/self-healing) &ndash; Automatic error recovery
- [Goal Engine](/docs/ai/goals) &ndash; Desired-state convergence
- [Memory](/docs/ai/memory) &ndash; Conversation context management
