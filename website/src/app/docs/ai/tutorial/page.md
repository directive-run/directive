...
- [Execution Patterns](/docs/ai/patterns) &ndash; Try parallel, DAG, race, reflect, and debate
- [Guardrails](/docs/ai/guardrails) &ndash; Add output validation and tool-call filtering
- [Memory](/docs/ai/memory) &ndash; Add conversation context management
- [Cross-Agent State](/docs/ai/cross-agent-state) &ndash; Share state between agents
- [Evals](/docs/ai/evals) &ndash; Measure quality with dataset-driven evaluation
