    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <p className="mt-2 text-xs text-slate-500 dark:text-slate-400">
          Select a scenario, adjust the risk threshold and budget sliders, then
          click &ldquo;Run Pipeline&rdquo; or &ldquo;Auto-Run All&rdquo;. Watch
          constraints fire in the DevTools panel as cases progress through the
          pipeline.
        </p>
      </section>
      ...
      <section>
        ...
        <div className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
          <p>
            ...
            with external signals, analyzed for risk, and dispositioned &ndash;
            all through constraint-driven resolution.
          </p>
          <ol className="list-inside list-decimal space-y-2 pl-1">
            ...
            <li>
              ...
              <code>key: enrich-$&#123;caseId&#125;</code> for dedup and retries
              with exponential backoff. Each resolver mutates facts to drive the
              next constraint.
            </li>
            <li>
              <strong className="text-slate-900 dark:text-slate-200">
              ...
              &ndash; The normalize resolver runs local <code>detectPII</code>{" "}
              regex scanner on merchant names and memo fields, redacting SSNs,
            ...
            <li>
              ...
              <code>humanReviewNeeded</code> fires. The budget slider controls
              when <code>budgetEscalation</code> kicks in. Both re-evaluate
      ...
      <section>
        ...
        <div className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
          <p>
            ...
            A fraud detection pipeline that normalizes, groups, enriches, and
            analyzes flagged transactions through 6 prioritized constraints, 6
            resolvers, 3 effects, and 9 derivations.
          </p>
          <p>
            <strong className="text-slate-900 dark:text-slate-200">How:</strong>{" "}
            Constraints declare &ldquo;when this is true, require that
            action.&rdquo; Priority and <code>after</code> ordering sequence the
            pipeline. Resolvers fulfill requirements, mutating facts to trigger
            the next constraint. Effects log stage changes, PII detections, and
            budget warnings.
          </p>
          <p>
            <strong className="text-slate-900 dark:text-slate-200">
            ...
            Competing constraints (analysis vs. escalation) handle edge cases
            declaratively. The DevTools panel shows every constraint evaluation,
            requirement, and state change in real time.
          </p>
        </div>
      </section>
