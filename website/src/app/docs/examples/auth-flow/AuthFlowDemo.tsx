    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
          <p>
            An authentication flow with token refresh, constraint ordering,
            and session management &ndash; all driven by Directive&rsquo;s
          ...
          <ol className="list-inside list-decimal space-y-2 pl-1">
            ...
            <li>
              ...
              and <code>expiresAt</code>, driving the{' '}
              <code>refreshNeeded</code> constraint reactively
            </li>
            <li>
      ...
      <section>
        ...
        <div className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
          ...
          <p>
            ...
            auto-tracked derivations eliminate manual timers and race conditions.
          </p>
        </div>
      </section>
