    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <p className="mt-2 text-xs text-slate-500 dark:text-slate-400">
          ...
          &ldquo;SAVE10&rdquo; or &ldquo;HALF&rdquo;, toggle auth, and attempt
          checkout. Watch constraints enforce business rules automatically.
        </p>
      </section>
      ...
      <section>
        ...
        <div className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
          <p>
            ...
            module gates checkout &ndash; all connected through constraints with
            priority ordering.
          </p>
      ...
      <section>
        ...
        <div className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
          ...
          <p>
            ...
            Business rules are constraints, not imperative code. Adding a new
            rule (bundle discount, minimum order) is just another constraint
            definition. Priority and <code>after</code> ordering ensure rules
      ...
      <section>
        ...
        {projectFiles && (
          <div className="mb-3">
            <StackBlitzOpen title="Shopping Cart" projectFiles={projectFiles} />
          </div>
        )}
        <CodeTabs
          tabs={[
