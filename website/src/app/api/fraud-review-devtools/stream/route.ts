/**
 * SSE endpoint for fraud review DevTools timeline events.
 *
 * Same pattern as /api/devtools/stream but reads from the fraud review orchestrator.
 */
export const runtime = 'nodejs'
export const dynamic = 'force-dynamic'

import { isAllowedOrigin, forbiddenResponse } from '@/lib/origin-check'
import { getFraudReviewTimeline } from '../../fraud-review-chat/orchestrator-singleton'
