          ...
          const result = await runner(
            {
              ...
              instructions:
                "You are a research assistant. Provide a well-structured research brief on the given topic. Include key findings, relevant studies, and a balanced analysis. Respond in 3-5 paragraphs.",
            },
            message,
          );
