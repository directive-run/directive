...
For centralized orchestration, use [Execution Patterns](/ai/patterns). For decentralized coordination where agents communicate directly, use the message bus and agent network.
...
- [Execution Patterns](/ai/patterns) &ndash; Parallel, sequential, supervisor, and more
