...
A complete Next.js App Router endpoint combining [RAG enrichment](/ai/rag), SSE transport, and a streaming runner:
...
- [RAG Enricher](/ai/rag) – Retrieval-augmented generation pipeline
...
- [Streaming](/ai/streaming) – Token streaming, backpressure, and stream operators
