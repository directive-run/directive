...
This is the minimal path. No orchestrator, no guardrails, no memory &ndash; just a runner function, an agent, and an input. When you need more, layer in the [orchestrator](/ai/orchestrator).
...
| Need | Solution |
|------|----------|
| Retry with backoff, fallback providers | [Resilience & Routing](/ai/resilience-routing) |
| Cost budget limits, model routing | [Resilience & Routing](/ai/resilience-routing) |
| Typed JSON output from LLMs | [Resilience & Routing](/ai/resilience-routing) |
| Guardrails (input/output validation) | [Orchestrator](/ai/orchestrator) |
| Approval workflows | [Orchestrator](/ai/orchestrator) |
| Token budgets | [Orchestrator](/ai/orchestrator) |
| Reactive UI state | [Orchestrator](/ai/orchestrator) + [Framework hooks](/ai/orchestrator#framework-integration) |
| Memory / conversation context | [Orchestrator](/ai/orchestrator) |
| Caching, circuit breakers, observability | [Resilience & Routing](/ai/resilience-routing) |
| Parallel / sequential / supervisor patterns | [Multi-Agent](/ai/multi-agent) |

---

## Next Steps

- [Resilience & Routing](/ai/resilience-routing) – retry, fallback, budgets, model selection, structured outputs
- [Orchestrator](/ai/orchestrator) – add guardrails, approvals, and state tracking
- [Streaming](/ai/streaming) – real-time token streaming
- [Guardrails](/ai/guardrails) – input validation and output safety
