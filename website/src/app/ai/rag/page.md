...
Combine the RAG enricher with [Agent Orchestrator](/ai/orchestrator) and [SSE Transport](/ai/sse-transport) for a full server-side chat pipeline:
...
- [SSE Transport](/ai/sse-transport) – Stream enriched responses over HTTP
- [Agent Orchestrator](/ai/orchestrator) – Full orchestrator API
- [Multi-Agent](/ai/multi-agent) – Parallel, sequential, and supervisor patterns
- [Guardrails](/ai/guardrails) – Input/output validation and safety
- [Streaming](/ai/streaming) – Real-time token streaming and backpressure
