...
- [Debug Timeline](/ai/debug-timeline) &ndash; Event recording and time-travel
- [DevTools](/ai/devtools) &ndash; Visual debugging UI
- [Testing](/ai/testing) &ndash; Breakpoint simulation in tests
