...
const principles = [
  ...
  },
  {
    ...
    bullets: [
      {
        bold: "Derivations",
        text: "are computed from facts. They don\u2019t store their own state \u2013 they recompute when their dependencies change.",
      },
      {
        bold: "Constraints",
        text: "evaluate against facts. They\u2019re pure functions that inspect reality and generate requirements.",
      },
      {
        bold: "Requirements",
        text: "are transient. They exist only as long as a constraint is active and unfulfilled.",
      },
    ],
    afterBullets: [
  ...
  },
  {
    ...
    bullets: [
      {
        bold: "Retry policies",
        text: "are declared on resolvers, not implemented ad-hoc in every async function",
      },
      { bold: "Timeouts", text: "prevent resolvers from hanging indefinitely" },
      {
        bold: "Error boundaries",
        text: "catch failures and provide configurable recovery",
      },
      {
        bold: "Deduplication keys",
        text: "prevent redundant work automatically",
      },
    ],
    afterBullets: [
  ...
  },
  {
    ...
    bullets: [
      {
        bold: "inspect()",
        text: "shows current facts, active constraints, pending requirements, and running resolvers",
      },
      {
        bold: "explain()",
        text: "traces why a particular requirement was generated \u2013 which constraint, which fact values",
      },
      {
        bold: "Time-travel",
        text: "lets you step through state changes and see exactly what happened at each point",
      },
    ],
    afterBullets: [
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-20 rounded-xl border border-slate-200/60 bg-slate-50/50 px-6 py-6 dark:border-slate-700/40 dark:bg-slate-800/30">
          ...
          <ul className="mt-4 space-y-2">
            {[
              {
                href: "/docs/why-directive",
                label: "Why Directive",
                description: "The specific problems Directive solves",
              },
              {
                href: "/docs/core-concepts",
                label: "Core Concepts",
                description: "The technical mental model",
              },
              {
