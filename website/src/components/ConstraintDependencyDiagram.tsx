...
const STEPS = [
  ...
  { id: 'authenticate', label: 'authenticate', colorScheme: 'primary' as const },
  { id: 'validateInput', label: 'validateInput', colorScheme: 'amber' as const },
  { id: 'processRequest', label: 'processRequest', colorScheme: 'emerald' as const },
] as const

const ANIMATION_STEPS = [
  'loadConfig', 'authenticate', 'arrow1',
  'validateInput', 'arrow2',
  'processRequest',
] as const
...
export const ConstraintDependencyDiagram = memo(function ConstraintDependencyDiagram() {
  ...
  const edges = useMemo<Edge[]>(() => [
    {
      ...
      targetHandle: 'top',
      type: 'labeled',
      data: { label: 'after', active: isArrowActive('arrow1'), colorScheme: 'primary' },
    },
    {
    ...
    },
    {
      ...
      targetHandle: 'top',
      type: 'labeled',
      data: { label: 'after', active: isArrowActive('arrow2'), colorScheme: 'amber' },
    },
  ], [isArrowActive])
