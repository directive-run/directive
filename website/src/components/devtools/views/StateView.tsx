      ...
      <div>
        ...
        <div className="space-y-2">
          <div className="flex font-mono text-xs">
            <span className="w-40 shrink-0 text-sky-600 dark:text-sky-400">
              eventCount
            </span>
            ...
            {Object.entries(value).map(([k, v]) => {
              ...
              return (
                <div key={k} className="flex font-mono text-xs">
                  ...
                  {isObject ? (
                    <pre className="min-w-0 flex-1 overflow-x-auto whitespace-pre-wrap rounded border border-zinc-200 bg-zinc-100 px-3 py-2 text-xs leading-relaxed text-zinc-700 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300">
