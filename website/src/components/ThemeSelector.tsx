...
const phosphorIcons = {
  ...
  dark: PhosphorDarkIcon,
  system: PhosphorSystemIcon,
};
const customIcons = {
  light: CustomLightIcon,
  dark: CustomDarkIcon,
  system: CustomSystemIcon,
};
        ...
        return (
          ...
          >
            <Icon
              className={clsx(
                "h-4 w-4",
                isActive ? iconColors.toggleActive : iconColors.toggleInactive,
              )}
            />
          </button>
        );
      ...
      >
        <LightIcon
          className={clsx(
            "h-4 w-4 dark:hidden",
            activeTheme === "system"
              ? iconColors.buttonLightSystem
              : iconColors.buttonLight,
          )}
        />
        <DarkIcon
          className={clsx(
            ...
            activeTheme === "system"
              ? iconColors.buttonDarkSystem
              : iconColors.buttonDark,
          )}
        />
      </ListboxButton>
