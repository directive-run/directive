...
export function ThemeOnboardingToast() {
  ...
  return (
    <div
      className={`fixed right-4 bottom-4 z-50 flex max-w-sm items-start gap-3 rounded-xl bg-white p-4 shadow-lg ring-1 ring-black/5 dark:bg-slate-800 dark:ring-white/10 ${
        reducedMotion
          ? exiting
            ? 'opacity-0'
            : 'opacity-100'
