  ...
  const edges = useMemo<Edge[]>(() => [
    {
      ...
      target: 'constraints',
      type: 'labeled',
      data: { label: 'change', active: isArrowActive('arrow1'), colorScheme: 'primary' },
    },
    {
      ...
      targetHandle: 'top',
      type: 'labeled',
      data: { label: 'require', active: isArrowActive('arrow2'), colorScheme: 'amber' },
    },
    {
      ...
      type: 'labeled',
      data: { label: 'resolve', active: isArrowActive('arrow3'), colorScheme: 'violet' },
    },
    {
