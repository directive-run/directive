...
export function ShareButton() {
  ...
  const handleTwitter = useCallback(() => {
    window.open(
      buildTwitterUrl(getShareContent()),
      "_blank",
      "noopener,noreferrer",
    );
    setIsOpen(false);
  ...
  const handleBluesky = useCallback(() => {
    window.open(
      buildBlueskyUrl(getShareContent()),
      "_blank",
      "noopener,noreferrer",
    );
    setIsOpen(false);
  ...
  const handleLinkedIn = useCallback(() => {
    window.open(
      buildLinkedInUrl(getShareContent()),
      "_blank",
      "noopener,noreferrer",
    );
    setIsOpen(false);
    ...
    <div className="relative" ref={panelRef}>
      ...
      {isOpen && (
        ...
        >
          ...
          >
            <svg
              className="h-4 w-4 flex-none text-black dark:text-white"
              viewBox="0 0 24 24"
              fill="currentColor"
            >
          ...
          >
            <svg
              className="h-4 w-4 flex-none text-[#0085ff]"
              viewBox="0 0 600 530"
              fill="currentColor"
            >
          ...
          >
            <svg
              className="h-4 w-4 flex-none text-[#0A66C2]"
              viewBox="0 0 24 24"
              fill="currentColor"
            >
          ...
          {hasNativeShare && (
            ...
            >
              <HandFist
                className="h-4 w-4 flex-none text-brand-primary dark:text-brand-primary-400"
                weight="duotone"
              />
              Share&hellip;
            </button>
          ...
          >
            {copied ? (
              ...
              <LinkSimple
                className="h-4 w-4 flex-none text-brand-accent dark:text-brand-accent-400"
                weight="duotone"
              />
            )}
