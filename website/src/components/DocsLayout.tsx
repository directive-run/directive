    ...
    <>
      ...
      {title && pathname !== '/' && pathname !== '' && (
        <>
          ...
          <meta property="og:image" content={`https://directive.run/api/og?title=${encodeURIComponent(title)}&section=Docs`} />
          <meta property="og:image:width" content="1200" />
          <meta property="og:image:height" content="630" />
          <meta name="twitter:card" content="summary_large_image" />
          <meta name="twitter:title" content={`${title} | Directive`} />
          {description && <meta name="twitter:description" content={description} />}
          <meta name="twitter:image" content={`https://directive.run/api/og?title=${encodeURIComponent(title)}&section=Docs`} />
        </>
      )}
      {title && description && (
        <DocumentationJsonLd
