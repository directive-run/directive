...
const FONT_PAIRINGS = [
  {
    id: 1,
    display: { name: 'Space Grotesk', family: '"Space Grotesk", system-ui, sans-serif' },
    body: { name: 'IBM Plex Sans', family: '"IBM Plex Sans", system-ui, sans-serif' },
...
const AE_VOTES: AgentVote[] = [
  // Product & Growth Team
  {
    ...
    comboSecondary: 'F',
    comboSecondaryReason: 'Indigo + Amber carries similar boldness with a slightly more technical read; it differentiates well on Product Hunt and in conference decks where competitors blend into cool-spectrum monotony.',
    typoPick: 1,
    typoReason:
    ...
    typoSecondary: 5,
    typoSecondaryReason: 'Satoshi + DM Sans has a premium editorial quality that could elevate Directive above typical open-source branding.',
    proposal: null,
  },
  {
    name: 'Avery Social',
    ...
    comboSecondary: 'K',
    comboSecondaryReason: 'Emerald + Purple is unusual enough to stop scrolling and has strong meme potential; the green-primary approach is rare meaning instant visual recognition in Discord avatars or social cards.',
    typoPick: 2,
    typoReason:
    ...
    typoSecondary: 5,
    typoSecondaryReason: 'Satoshi has strong personality at larger sizes, excellent for social media headers and announcement graphics where you need premium quality in a single glance.',
    proposal: {
      type: 'social-kit',
      description: 'Create a simplified logomark variant optimized for 32x32 and 16x16 rendering for GitHub org avatars, npm badges, and Discord server icons.',
      rationale: 'The full wordmark becomes unreadable at small sizes used across most developer social touchpoints.',
    },
  },
  {
    name: 'Sam Content',
    ...
    comboSecondary: 'J',
    comboSecondaryReason: 'Indigo + Teal is a cool-spectrum pair with excellent contrast that stays readable in long-form documentation without creating visual fatigue during extended reading sessions.',
    typoPick: 4,
    typoReason:
    ...
    typoSecondary: 1,
    typoSecondaryReason: 'Space Grotesk + IBM Plex Sans is the strongest "technical authority" pairing — IBM Plex Mono for code blocks is battle-tested in documentation contexts.',
    proposal: null,
  },
  {
    name: 'Taylor Product',
    ...
    comboSecondary: 'C',
    comboSecondaryReason: 'Indigo + Emerald is a pragmatic alternative that still feels technical; the emerald accent maps to "success/resolved" states, creating coherence between brand and product experience.',
    typoPick: 3,
    typoReason:
    ...
    typoSecondary: 1,
    typoSecondaryReason: 'Space Grotesk + IBM Plex is a strong differentiation play; it trades some familiarity for memorability which could be worth it if adoption depends on standing out.',
    proposal: {
      type: 'testing',
      description: 'Run a quick A/B preference test in a developer Discord or Twitter poll with the top 2-3 color combos shown on a mock npm README card.',
      rationale: 'Actual developer reactions will validate or override our assumptions about what reads as trustworthy vs. novel.',
    },
  },
  {
    name: 'Blake UX',
    ...
    comboSecondary: 'I',
    comboSecondaryReason: 'Teal + Amber is the highest-contrast complementary pair with excellent differentiation across all CVD types; the warm/cool split creates clear visual hierarchy without relying on hue alone.',
    typoPick: 1,
    typoReason:
    ...
    typoSecondary: 4,
    typoSecondaryReason: 'Outfit has excellent weight distribution across its variable font range for precise visual hierarchy control in a design system.',
    proposal: {
      type: 'accessibility',
      description: 'Generate a full accessibility matrix: contrast ratios for every foreground/background combination at AA and AAA levels, plus simulated renders under protanopia, deuteranopia, and tritanopia.',
      rationale: 'This becomes part of the brand guidelines to prevent downstream accessibility regressions in docs and marketing.',
    },
  },
  {
    ...
    comboSecondary: 'F',
    comboSecondaryReason: 'Indigo/Amber provides strong warm-cool contrast separation, making it easy to distinguish warning states from informational states without relying on iconography.',
    typoPick: 1,
    typoReason:
    ...
    typoSecondary: 4,
    typoSecondaryReason: "Outfit + IBM Plex Mono retains the code font advantage while Outfit's strong weight range creates clearer visual hierarchy in dense compliance documentation.",
    proposal: {
      type: 'compliance',
      description: 'Run a WCAG 2.2 contrast audit on the final palette at 14px body text and 12px code text sizes before shipping.',
      rationale: 'Contrast ratios that pass at 16px often fail at sizes actually used in docs and terminal output.',
    },
  },
  {
    ...
    comboSecondary: 'A',
    comboSecondaryReason: 'Purple/Emerald carries a similar declarative-to-resolved semantic arc; purple suggests the intelligence layer, emerald the successful resolution, mirroring SAT-solver visualizations.',
    typoPick: 5,
    typoReason:
    ...
    typoSecondary: 1,
    typoSecondaryReason: "Space Grotesk has a mathematical quality that resonates with constraint-programming documentation, and IBM Plex Mono's clarity is well-suited for type signatures and inference rules.",
    proposal: null,
  },
  {
    ...
    comboSecondary: 'E',
    comboSecondaryReason: 'Blue/Teal has minimal hue distance meaning fewer repaint artifacts during CSS transitions and excellent performance in GPU-composited layer animations.',
    typoPick: 2,
    typoReason:
    ...
    typoSecondary: 3,
    typoSecondaryReason: "Inter is one of the most aggressively cached Google Fonts so it's often a zero-byte download for returning users, and JetBrains Mono is already cached on most developer machines.",
    proposal: {
      type: 'performance',
      description: 'Ship fonts as woff2 subsets with unicode-range splitting and use font-display: optional for code fonts to prevent layout jank.',
      rationale: 'Streaming UI can never show layout shifts from late-loading monospace metrics.',
    },
  },
  {
    ...
    comboSecondary: 'H',
    comboSecondaryReason: "Blue/Purple is similarly low-risk and familiar to developers from VS Code and Discord — we won't burn cycles explaining an unconventional palette.",
    typoPick: 3,
    typoReason:
    ...
    typoSecondary: 2,
    typoSecondaryReason: "Geist is MIT-licensed and ships natively with Next.js via next/font — literally zero setup cost and signals modern tooling alignment.",
    proposal: null,
  },
  {
    name: 'Val Analytics',
    ...
    comboSecondary: 'F',
    comboSecondaryReason: 'Indigo/Amber retains the warm accent CTA advantage while indigo reads slightly more technical, which may test better with the senior-engineer segment.',
    typoPick: 4,
    typoReason:
    ...
    typoSecondary: 5,
    typoSecondaryReason: 'Satoshi/DM Sans has an editorial premium feel that performs well in tests for perceived product quality, correlating with higher trial-to-adoption conversion.',
    proposal: {
      type: 'testing',
      description: 'Set up a simple split test on the landing page hero with the top two combos measuring scroll depth and CTA click-through before locking the palette.',
      rationale: 'A 48-hour test with even moderate traffic gives directional signal and removes subjectivity.',
    },
  },
  // Executive Team
  {
    ...
    comboSecondary: 'H',
    comboSecondaryReason: 'Blue/Purple reads as trusted-yet-intelligent, positioning well against incumbent state management libraries and signaling enterprise readiness.',
    typoPick: 1,
    typoReason:
    ...
    typoSecondary: 4,
    typoSecondaryReason: 'Outfit creates strong visual hierarchy for documentation-heavy marketing, which is where developer tools win or lose adoption battles.',
    proposal: null,
  },
  {
    name: 'Morgan Finance',
    ...
    comboSecondary: 'E',
    comboSecondaryReason: 'Blue/Teal is the lowest-risk palette — universally readable, no accessibility remediation costs, zero chance of clashing with co-marketing partner brands.',
    typoPick: 2,
    typoReason:
    ...
    typoSecondary: 3,
    typoSecondaryReason: 'Inter and JetBrains Mono are both open-source workhorses with massive community maintenance — near-zero risk of abandonment or licensing changes.',
    proposal: {
      type: 'licensing',
      description: 'Confirm all finalist fonts are SIL Open Font License or equivalent with no per-seat or commercial-use licensing exposure as adoption scales.',
      rationale: 'Zero per-seat or redistribution restrictions eliminates future cost surprises.',
    },
  },
  {
    name: 'Jordan Legal',
    ...
    comboSecondary: 'I',
    comboSecondaryReason: 'Teal/Amber as a complementary pair delivers highest contrast making WCAG AAA compliance achievable on most surfaces, reducing accessibility litigation risk.',
    typoPick: 1,
    typoReason:
    ...
    typoSecondary: 5,
    typoSecondaryReason: 'Satoshi (OFL) and DM Sans (OFL) have clean licensing, and the editorial pairing creates distinctive enough visual identity to support trade dress registration.',
    proposal: {
      type: 'compliance',
      description: 'Run a WCAG 2.2 AA audit against the winning combo — specifically test primary color on both white and dark backgrounds at body-text size to confirm 4.5:1 contrast ratios hold.',
      rationale: 'Documented compliance reduces legal exposure and signals engineering quality to enterprise buyers.',
    },
  },
  {
    name: 'Nova Ventures',
    ...
    comboSecondary: 'D',
    comboSecondaryReason: 'Purple/Amber is bold and commanding; it tells a venture-stage story of authority and ambition that stands out in pitch decks against the sea of blue developer tools.',
    typoPick: 5,
    typoReason:
    ...
    typoSecondary: 1,
    typoSecondaryReason: 'Space Grotesk has enough geometric personality to feel differentiated from the Inter/Geist monoculture while still reading as technical.',
    proposal: {
      type: 'brand-element',
      description: 'Pair the winning combo with a simple geometric logomark based on the "constraint resolution" concept — a shape that transforms or completes.',
      rationale: 'Builds ownable visual IP beyond just color and type, creating a memorable symbol for the category.',
    },
  },
  {
    name: 'Morgan HR',
    ...
    comboSecondary: 'G',
    comboSecondaryReason: 'Purple/Teal has good energy for community swag and contributor badges — the two colors reproduce well on t-shirts, stickers, and dark-mode GitHub profile elements.',
    typoPick: 3,
    typoReason:
    ...
    typoSecondary: 2,
    typoSecondaryReason: "Geist Sans has excellent readability across screen sizes and the modern aesthetic appeals to the younger developer demographic we want contributing.",
    proposal: {
      type: 'community',
      description: 'Define a "community" color variant — slightly warmer or lighter — for contributor-facing materials like onboarding docs, Discord branding, and welcome emails.',
      rationale: 'The brand should feel human alongside the technical precision in contributor-facing contexts.',
    },
  },
  // Engineering Team
  {
    ...
    comboSecondary: 'E',
    comboSecondaryReason: 'Blue-teal is the safest enterprise-grade palette; it reads as mature tooling rather than a startup experiment, which matters when engineering leads evaluate dependencies.',
    typoPick: 1,
    typoReason:
    ...
    typoSecondary: 4,
    typoSecondaryReason: 'Outfit provides strong visual hierarchy for technical docs and pairs well with IBM Plex for dense API reference pages that signal maturity.',
    proposal: null,
  },
  {
    name: 'Riley Systems',
    ...
    comboSecondary: 'I',
    comboSecondaryReason: 'Teal-amber guarantees legibility on low-quality displays and under f.lux/Night Shift color shifts — important for developers working late.',
    typoPick: 2,
    typoReason:
    ...
    typoSecondary: 1,
    typoSecondaryReason: 'IBM Plex Mono has exceptional glyph differentiation (0/O, 1/l/I) reducing misreading in code samples, though the full Plex family has larger total download weight.',
    proposal: {
      type: 'verification',
      description: 'Run a Lighthouse audit on font loading strategy — subset to Latin, use font-display: swap, preload only display weight. Budget: zero CLS, total payload under 80KB.',
      rationale: 'Font performance is a proxy for engineering credibility in a developer library.',
    },
  },
  {
    ...
    comboSecondary: 'F',
    comboSecondaryReason: 'Indigo-amber gives sharp visual separation for inline code highlights and warning/deprecation callouts in API docs, making scanning long reference pages faster.',
    typoPick: 1,
    typoReason:
    ...
    typoSecondary: 5,
    typoSecondaryReason: 'JetBrains Mono with Satoshi body creates a clear visual break between prose and code, and JetBrains Mono has the best ligature control for TypeScript-heavy documentation.',
    proposal: null,
  },
  {
    name: 'Dana Frontend',
    ...
    comboSecondary: 'G',
    comboSecondaryReason: 'Purple-teal maintains the purple primary for component theming while teal gives a more energetic, modern accent that works well for interactive states and hover effects in dark mode.',
    typoPick: 2,
    typoReason:
    ...
    typoSecondary: 3,
    typoSecondaryReason: 'Inter is the most battle-tested body font for web component systems with proven cross-browser rendering, and Manrope provides display personality without implementation risk.',
    proposal: {
      type: 'implementation',
      description: 'Define CSS custom properties for the full color scale from day one (--directive-primary-50 through --directive-primary-950) supporting dark mode, high contrast, and component variants.',
      rationale: 'Avoids ad-hoc hex values and prevents tech debt in the design system.',
    },
  },
  {
    ...
    comboSecondary: 'J',
    comboSecondaryReason: 'Indigo-teal renders cleanly in terminal emulators and web dashboards, maintaining distinction even in 256-color terminal fallback modes.',
    typoPick: 1,
    typoReason:
    ...
    typoSecondary: 2,
    typoSecondaryReason: 'Geist Mono renders cleanly at small sizes in terminal contexts and its monospace metrics are well-calibrated for log output and structured CLI tables.',
    proposal: {
      type: 'verification',
      description: 'Document named ANSI terminal equivalents for brand colors (e.g., teal maps to ANSI cyan, amber to ANSI yellow) so CLI tools use on-brand colors without custom 24-bit escape sequences.',
      rationale: 'Makes brand consistency achievable even in constrained terminal color environments.',
    },
  },
]
...
const COMBO_SECONDARY_TALLIES = tallyVotes(AE_VOTES, (v) => v.comboSecondary, COMBO_IDS)
const TYPO_TALLIES = tallyVotes(AE_VOTES, (v) => v.typoPick, TYPO_IDS)
const TYPO_SECONDARY_TALLIES = tallyVotes(AE_VOTES, (v) => v.typoSecondary, TYPO_IDS)
