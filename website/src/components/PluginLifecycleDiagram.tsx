...
import { Wrench, Play, Database, Function as FunctionIcon, ArrowsClockwise, Stop } from '@phosphor-icons/react'
import {
  DiagramWrapper,
  DiagramToolbar,
  useAnimationLoop,
...
const STEPS = [
  { id: 'onInit', label: 'onInit', subtitle: 'system created', colorScheme: 'slate' as const },
  { id: 'onStart', label: 'onStart', subtitle: 'system.start()', colorScheme: 'primary' as const },
  { id: 'onFactChange', label: 'onFactChange', subtitle: 'facts mutated', colorScheme: 'amber' as const },
  { id: 'onDerivation', label: 'onDerivation', subtitle: 'values recomputed', colorScheme: 'violet' as const },
  { id: 'onResolve', label: 'onResolve', subtitle: 'requirements fulfilled', colorScheme: 'emerald' as const },
  { id: 'onStop', label: 'onStop', subtitle: 'system.stop()', colorScheme: 'red' as const },
] as const
  ...
  const edges = useMemo<Edge[]>(() => [
    {
      ...
      target: 'onStart',
      type: 'labeled',
      data: { label: 'setup', active: isArrowActive('arrow1'), colorScheme: 'slate' },
    },
    {
      ...
      targetHandle: 'top',
      type: 'labeled',
      data: { label: 'running', active: isArrowActive('arrow2'), colorScheme: 'primary' },
    },
    {
      ...
      target: 'onDerivation',
      type: 'labeled',
      data: { label: 'recompute', active: isArrowActive('arrow3'), colorScheme: 'amber' },
    },
    {
      ...
      targetHandle: 'top',
      type: 'labeled',
      data: { label: 'reconcile', active: isArrowActive('arrow4'), colorScheme: 'violet' },
    },
    {
      ...
      target: 'onStop',
      type: 'labeled',
      data: { label: 'teardown', active: isArrowActive('arrow5'), colorScheme: 'emerald' },
    },
  ], [isArrowActive])
