...
> = {
  warning: {
    ...
    dismiss:
      "text-lime-700 hover:text-lime-950 dark:text-lime-800 dark:hover:text-lime-950",
  },
  info: {
    ...
    dismiss:
      "text-sky-700 hover:text-sky-950 dark:text-sky-800 dark:hover:text-sky-950",
  },
  success: {
    ...
    dismiss:
      "text-emerald-700 hover:text-emerald-950 dark:text-emerald-800 dark:hover:text-emerald-950",
  },
  error: {
    ...
    dismiss:
      "text-red-700 hover:text-red-950 dark:text-red-800 dark:hover:text-red-950",
  },
};
  ...
  return (
    ...
    >
      {notifications.map((notification: NotificationDef, index: number) => {
        ...
        const staggerDelay = reducedMotion.current
          ? undefined
