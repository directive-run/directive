...
const STEPS = [
  { id: 'loadUser', label: 'loadUser', subtitle: 'priority: 100', colorScheme: 'primary' as const },
  { id: 'checkAuth', label: 'checkAuth', subtitle: 'priority: 90', colorScheme: 'primary' as const },
  { id: 'validateCart', label: 'validateCart', subtitle: 'priority: 50', colorScheme: 'amber' as const },
  { id: 'applyPromo', label: 'applyPromo', subtitle: 'priority: 40', colorScheme: 'violet' as const },
  { id: 'checkout', label: 'checkout', subtitle: 'priority: 10', colorScheme: 'emerald' as const },
] as const

const ANIMATION_STEPS = [
  'loadUser', 'checkAuth', 'arrow1',
  'validateCart', 'arrow2',
  'applyPromo', 'arrow3',
  'checkout',
] as const
...
export const ConstraintPriorityDiagram = memo(function ConstraintPriorityDiagram() {
