...
- [`fcb6c9c`](https://github.com/directive-run/directive/commit/fcb6c9cf54c744fdbcfbef96a0806ae994261336) Thanks [@jasoncomes](https://github.com/jasoncomes)! - Close the playground "runner forgot to ship" gap that left every `generate_module → playground_link` chain booting StackBlitz to a library file that exported a binding and exited. v0.4.0 lands the UX-lens AE review's "paired files always" pattern:
