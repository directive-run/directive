...
describe("Comparison: Read 10 Keys", () => {
  ...
  (() => {
    ...
    bench("Directive", () => {
      let _s = 0;
      for (let i = 0; i < 10; i++) _s += sys.facts[`k${i}`];
    });
  })();
  ...
  (() => {
    ...
    bench("MobX", () => {
      let _s = 0;
      for (let i = 0; i < 10; i++) _s += store[`k${i}`];
    });
  })();
  ...
  (() => {
    ...
    bench("Preact Signals", () => {
      let _s = 0;
      for (let i = 0; i < 10; i++) _s += sigs[i].value;
    });
  })();
  ...
  (() => {
    ...
    bench("Jotai", () => {
      let _s = 0;
      for (let i = 0; i < 10; i++) _s += store.get(atoms[i]);
    });
  })();
});
