...
- [#109](https://github.com/directive-run/directive/pull/109) [`e0d300e`](https://github.com/directive-run/directive/commit/e0d300e0a92c80cb7430bbe7bd56b6f5678ce61e) Thanks [@jasoncomes](https://github.com/jasoncomes)! - **A subscription with a constant key no longer dies the first time anything else in the system changes.**
