import type { DebugEventType, CircuitState, DagNodeStatus } from "./types";
...
export const CIRCUIT_STATE_COLORS: Record<CircuitState, { bg: string; text: string; label: string }> = {
