...
- **"Project"** means the Directive software and all associated packages published under the `@directive-run` npm scope.
...
This Agreement is effective upon your first submission of a Contribution to the Project.
